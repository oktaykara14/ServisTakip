...
///// PRIVATE METHODS /////
    ...
    var _qz = {
        ...
        websocket: {
            ...
            connectConfig: {
                host: ["localhost", "servis.manas.com.tr"], //hosts QZ Tray can be running on
                    ...
                    var deeper = function() {
                        ...
                        if ((config.usingSecure && config.port.portIndex >= config.port.secure.length)
                            ...
                            if (config.hostIndex >= config.host.length - 1) {
                                ...
                                reject(new Error("QZ ile bağlantı kurulamadı"));
                                return;
                            } else {
                                config.hostIndex++;
                    ...
                    if (_qz.websocket.connection != null) {
                        ...
                        _qz.websocket.connection.onopen = function(evt) {
                            if (!_qz.websocket.connection.established) {
                                _qz.log.trace(evt);
                                _qz.log.info("QZ Tray ile bağlantı kuruldu " + address);
                        ...
                        reject(new Error("Web Soket Bağlantısı kurulamadı"));
                    }
                },
