...
class CreateTableArizafiyat extends Migration {
	...
	public function up()
	{
		Schema::create('arizafiyat', function(Blueprint $table)
		{
			$table->increments('id');
            ...
            $table->integer('arizakayit_id')->unsigned();
