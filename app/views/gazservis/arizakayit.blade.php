...
<div class="page-title">
    <h1>Gaz Servis <small>Arıza Kayıt Ekranı</small></h1>
</div>
@stop
...
@section('scripts')
    ...
    <script>
        ...
        var oTable = table.DataTable({
            ...
            "bProcessing": true,
            "ajax": {
                "url": "{{ URL::to('gazservis/arizakayitlist') }}",
                "type": "POST",
                "data": {
            ...
            "fnDrawCallback" : function() {
                $(document).on("click", ".delete", function () {
                    var id = $(this).data('id');
                    $(".modal-footer #sayacid").attr('href',"{{ URL::to('gazservis/arizakayitsil') }}/"+id );
                });
            },
            "aaSorting": [[6,'desc']],
            ...
            <div class="portlet box">
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        ...
                        <a href="{{ URL::to('gazservis/arizakayitekle') }}" class="btn btn-default btn-sm">
