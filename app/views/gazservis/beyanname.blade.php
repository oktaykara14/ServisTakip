...
@section('scripts')
    ...
    <script>
        ...
        var oTable = table.DataTable({
            ...
            "bProcessing": true,
            "ajax": {
                "url": "{{ URL::to('gazservis/beyannamelist') }}",
                "type": "POST",
                "data": {
                }
            },
            ...
            "fnDrawCallback" : function() {
                $(document).on("click", ".delete", function () {
                    var id = $(this).data('id');
                    $(".modal-footer #sayacid").attr('href',"{{ URL::to('gazservis/beyannamesil') }}/"+id);
                });
            },
            "aaSorting": [[0,'desc']],
            ...
            <div class="portlet box">
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        ...
                        <a href="{{ URL::to('gazservis/beyannameekle') }}" class="btn btn-default btn-sm">
