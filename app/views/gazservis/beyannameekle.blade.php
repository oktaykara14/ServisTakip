...
<div class="page-title">
    <h1>Beyanname <small>Ekleme Ekranı</small></h1>
</div>
@stop
...
@section('page-script')
<script src="{{ URL::to('pages/gazservis/form-validation-6.js') }}"></script>
@stop
...
jQuery(document).ready(function() {
    ...
    var oTable = table.DataTable({
        ...
        "bProcessing": true,
        "ajax": {
            "url": "{{ URL::to('gazservis/beyannamekayitlist') }}",
            "type": "POST",
            "data": {
            }
        },
...
<div class="portlet box">
    <div class="portlet-title">
        <div class="caption">
            <i class="fa fa-plus"></i>Beyanname Ekle
        </div>
    </div>
    <div class="portlet-body form">
        <!-- BEGIN FORM-->
        <form action="{{ URL::to('gazservis/beyannameekle') }}" id="form_sample" method="POST" class="form-horizontal" novalidate="novalidate" enctype="multipart/form-data">
            <div class="form-body">
                ...
                <div class="form-group col-sm-6 col-xs-12">
                    ...
                    <div class="input-icon right col-xs-8">
                        <i class="fa"></i><input type="text" id="beyannameno" name="beyannameno" value="{{ Input::old('beyannameno') ? Input::old('beyannameno') : $beyannameno }}" data-required="1" class="form-control">
                    </div>
                </div>
                <div class="form-group col-sm-6 col-xs-12">
                    ...
                    <div class="input-icon right col-xs-8">
                        <i class="fa"></i><div class="input-group input-medium date date-picker uretim" style="padding-left: 12px !important;" data-date-format="dd-mm-yyyy" data-date-viewmode="years">
                            <input type="text" id="tarih" name="tarih" class="form-control" value="{{Input::old('tarih') ? Input::old('tarih') : $tarih }}">
                ...
                <div class="form-group col-xs-12">
                    ...
                    <label class="col-sm-3 col-xs-6 beyannameadet" style="padding-top: 9px">{{ Input::old('beyannameadet') ? Input::old('beyannameadet') : $adet }}</label>
                    <input type="text" id="secilenler" name="secilenler" value="{{ Input::old('secilenler') ? Input::old('secilenler') : $sayacgelenlist }}" class="form-control hide"/>
                    <input type="text" id="beyannameadet" name="beyannameadet" value="{{ Input::old('beyannameadet') ? Input::old('beyannameadet') : $adet }}" class="form-control hide"/>
                </div>
            ...
            <div class="form-actions">
                <div class="row">
                    <div class="col-xs-12" style="text-align: center">
                        ...
                        <a href="{{ URL::to('gazservis/beyanname')}}" class="btn default">Vazgeç</a>
                    </div>
                </div>
            </div>
        </form>
