...
@section('page-title')
    <div class="page-title">
        <h1>Su Servis <small>Sayaç Uyarılar & Sonuçlar Bilgi Ekranı</small></h1>
    </div>
@stop
...
@section('scripts')
    ...
    <script>
        ...
        var oTable = table.DataTable({
            ...
            "bProcessing": true,
            "ajax": {
                "url": "{{ URL::to('sudatabase/uyarilarlist') }}",
                "type": "POST",
                "data": {
                }
            },
    ...
    <script>
        $(document).on("click", ".delete", function () {
            var id = $(this).data('id');
            $(".modal-footer #sayacid").attr('href',"{{ URL::to('sudatabase/uyarisil') }}/"+id);
        });
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box">
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        <a href="{{ URL::to('sudatabase/uyariekle') }}" class="btn btn-default btn-sm">
