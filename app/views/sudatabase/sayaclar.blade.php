...
<div class="page-title">
    <h1>Su Servis <small>Sayaç Listesi</small></h1>
</div>
@stop
...
@section('scripts')
    ...
    <script>
        ...
        var oTable = table.DataTable({
            ...
            "bProcessing": true,
            "ajax": {
                "url": "{{ URL::to('sudatabase/sayaclist') }}",
                "type": "POST",
                "data": {
                }
            },
    ...
    $(document).on("click", ".delete", function() {
         var id = $(this).data('id');
         $(".modal-footer #sayacid").attr('href',"{{ URL::to('sudatabase/sayacsil') }}/"+id);
    });
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box">
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        <a href="{{ URL::to('sudatabase/tektekekle') }}" class="btn btn-default btn-sm">
                            <i class="fa fa-pencil"></i> Tek Tek Sayaç Ekle </a>
                        <a href="{{ URL::to('sudatabase/siraliekle') }}" class="btn btn-default btn-sm">
