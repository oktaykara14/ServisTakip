...
<div class="page-title">
    <h1>Su Sayaç Fiyatı <small>Ekleme Ekranı</small></h1>
</div>
@stop
...
@section('page-script')
<script src="{{ URL::to('pages/sudatabase/form-validation-7.js') }}"></script>
@stop
...
<div class="portlet box">
    ...
    <div class="portlet-body form">
        <!-- BEGIN FORM-->
        <form action="{{ URL::to('sudatabase/fiyatekle') }}" id="form_sample" method="POST" class="form-horizontal" novalidate="novalidate">
            <div class="form-body">
            ...
            <div class="row">
                <div class="col-xs-12" style="text-align: center">
                    ...
                    <a href="{{ URL::to('sudatabase/sayacfiyat')}}" class="btn default">Vazgeç</a>
                </div>
            </div>
            </div>
        </form>
