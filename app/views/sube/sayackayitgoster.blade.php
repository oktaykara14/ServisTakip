...
<div class="page-title">
    <h1>Şube Sayaç Kayıt <small>Bilgi Ekranı</small></h1>
</div>
@stop
        ...
        <form action="" id="form_sample" class="form-horizontal" novalidate="novalidate">
            <div class="form-body">
                ...
                <div class="form-group">
                    ...
                    <label class="col-sm-3 col-xs-8" style="padding-top: 7px">{{ $sayaccap->capadi }}</label>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <label class="col-xs-8" style="padding-top: 7px">{{ $sayacgelen->sokulmenedeni }} </label>
                </div>
                <div class="form-group col-sm-6 col-xs-12">
                    <label class="control-label col-xs-4">Servis Sayacı Takılma Tarihi:</label>
                    <label class="col-sm-3 col-xs-8" style="padding-top: 7px">{{ $sayacgelen->takilmatarihi ? date("d-m-Y", strtotime($sayacgelen->takilmatarihi)) : '' }}</label>
                </div>
                <div class="form-group col-sm-6 col-xs-12">
                    <label class="col-xs-4 control-label">Servis Sayacı Takılma Endeksi:</label>
                    <label class="col-xs-8" style="padding-top: 7px">{{ str_replace('.',',',round($sayacgelen->endeks,3)) }} </label>
                </div>
            ...
            <div class="row">
                <div class="col-xs-12" style="text-align: center">
                    <a href="{{ URL::to('sube/sayackayit')}}" class="btn default">Tamam</a>
                </div>
            </div>
            </div>
        </form>
