...
<div class="page-title">
    <h1>Şube <small>Beyanname Ekranı</small></h1>
</div>
@stop
        ...
        var oTable = table.DataTable({
            ...
            "fnDrawCallback" : function() {
                $(document).on("click", ".delete", function () {
                    var id = $(this).data('id');
                    $(".modal-footer #sayacid").attr('href',"{{ URL::to('sube/beyannamesil') }}/"+id );
                });
            },
            "aaSorting": [[0,'desc']],
            ...
            <div class="portlet box">
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        ...
                        <a href="{{ URL::to('sube/beyannameekle') }}" class="btn btn-default btn-sm">
