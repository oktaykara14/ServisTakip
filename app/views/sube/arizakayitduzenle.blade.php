...
<div class="page-title">
    <h1>Şube Arıza Kayıt <small>Düzenleme Ekranı</small></h1>
</div>
@stop
...
@section('page-script')
<script src="{{ URL::to('pages/sube/form-validation-10.js') }}"></script>
@stop
    ...
    $(document).ready(function() {
        ...
        $('.serinoekle').click(function () {
            ...
            if (yeniserino === "") {
                ...
                $.blockUI();
                $.getJSON("{{ URL::to('sube/serinoekle') }}", {yeniserino: yeniserino,uretimyer:uretimyer,sayactur:0,sayacadi:sayacadi,sayaccap:sayaccap,sayacgelen:sayacgelen}, function (event) {
                    toastr[event.type](event.text, event.title);
...
<div class="portlet box">
    ...
    <div class="portlet-body form">
        <!-- BEGIN FORM-->
        <form action="{{ URL::to('sube/arizakayitduzenle/'.$arizakayit->id.'') }}" id="form_sample" method="POST" class="form-horizontal" novalidate="novalidate" enctype="multipart/form-data">
            <div class="form-body">
