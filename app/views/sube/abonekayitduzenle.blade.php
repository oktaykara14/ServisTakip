...
<div class="page-title">
    <h1>Abone Kayıt <small>Düzenleme Ekranı</small></h1>
</div>
@stop
...
<script>
    $(document).ready(function() {
        ...
        $('.getir').click(function(){
            ...
            if(serino!==""){
                $.blockUI();
                $.getJSON("{{ URL::to('sube/abonebilgi') }}",{serino:serino,subekodu:subekodu,uretimyer:uretimyer,abone:abone}, function (event) {
                    if(event.durum){
                        var sayac = event.sayac;
                        $("#sayactur"+no).select2("val",sayac.sayactur_id).valid();
                        $("#sayacadi"+no).select2("val",sayac.sayacadi_id).valid();
...
<div class="portlet box">
    <div class="portlet-title">
        <div class="caption">
            <i class="fa fa-pencil"></i>Abone Kayıdı Düzenle
        </div>
    </div>
    <div class="portlet-body form">
        <!-- BEGIN FORM-->
        <form action="{{ URL::to('sube/abonekayitduzenle/'.$abone->id.'') }}" id="form_sample" method="POST" class="form-horizontal" novalidate="novalidate">
            <div class="form-body">
                ...
                <div class="form-group col-xs-12 hide">
                    <input type="text" id="abone" name="abone" value="{{ $abone->id }}" data-required="1" class="form-control">
                ...
                <div class="form-group">
                    ...
                    <div class="input-icon right col-xs-8">
                        <i class="fa"></i><select class="form-control select2me select2-offscreen" id="cariadi" name="cariadi" tabindex="-1" title="">
                            <option value="">Seçiniz...</option>
                            @if((Input::old('cariadi') ? Input::old('cariadi') : $abone->netsiscari_id )==$sube->netsiscari_id )
                            ...
                            @foreach($netsiscariler as $netsiscari)
                                @if((Input::old('cariadi') ? Input::old('cariadi') : $abone->netsiscari_id )==$netsiscari->id )
                ...
                <div class="form-group col-sm-6 col-xs-12">
                    ...
                    <div class="input-icon right col-sm-8 col-xs-9">
                        <i class="fa"></i><input type="text" id="adisoyadi" name="adisoyadi" value="{{ Input::old('adisoyadi') ? Input::old('adisoyadi') : $abone->adisoyadi }}" maxlength="200" data-required="1" class="form-control">
                    </div>
                </div>
                <div class="form-group col-sm-6 col-xs-12">
                    ...
                    <div class="input-icon right col-sm-8 col-xs-9">
                        <i class="fa"></i><select class="form-control select2me select2-offscreen" id="uretimyer" name="uretimyer" tabindex="-1" title="">
                            ...
                            @foreach($uretimyerleri as $uretimyeri)
                                @if((Input::old('uretimyer') ? Input::old('uretimyer') : $abone->uretimyer_id)==$uretimyeri->id)
                ...
                <div class="form-group col-sm-6 col-xs-12">
                    ...
                    <div class="col-sm-8 col-xs-9">
                        <input type="text" id="vergidairesi" name="vergidairesi" value="{{ Input::old('vergidairesi') ? Input::old('vergidairesi') : $abone->vergidairesi }}" maxlength="30" data-required="1" class="form-control">
                    </div>
                </div>
                <div class="form-group col-sm-6 col-xs-12">
                    <label class="control-label col-sm-4 col-xs-3">TC Kimlik / Vergi No:<span class="required" aria-required="true"> * </span></label>
                    <div class="input-icon right col-sm-8 col-xs-9">
                        <i class="fa"></i><input type="text" id="tckimlikno" name="tckimlikno" value="{{ Input::old('tckimlikno') ? Input::old('tckimlikno') : $abone->tckimlikno }}" maxlength="11" data-required="1" class="form-control">
                    </div>
                </div>
                <div class="form-group col-sm-6 col-xs-12">
                    <label class="control-label col-sm-4 col-xs-3">Abone No:</label>
                    <div class="col-sm-8 col-xs-9">
                        <input type="text" id="aboneno" name="aboneno" value="{{ Input::old('aboneno') ? Input::old('aboneno') : $abone->abone_no }}" maxlength="10" data-required="1" class="form-control">
                    </div>
                </div>
                <div class="form-group col-sm-6 col-xs-12">
                    <label class="control-label col-sm-4 col-xs-3">Telefonu:<span class="required" aria-required="true"> * </span></label>
                    <div class="input-icon right col-sm-8 col-xs-9">
                        <i class="fa"></i><input type="tel" id="telefon" name="telefon" value="{{ Input::old('telefon') ? Input::old('telefon') : $abone->telefon }}" maxlength="17" data-required="1" class="form-control">
                    </div>
                </div>
                <div class="form-group col-sm-6 col-xs-12">
                    <label class="control-label col-sm-4 col-xs-3">Fatura Adresi:<span class="required" aria-required="true"> * </span></label>
                    <div class="input-icon right col-sm-8 col-xs-9">
                        <i class="fa"></i><input type="text" id="adres" name="adres" value="{{ Input::old('adres') ? Input::old('adres') : $abone->faturaadresi }}" maxlength="100" data-required="1" class="form-control">
                    </div>
                </div>
                <div class="form-group col-sm-6 col-xs-12">
                    <label class="control-label col-sm-4 col-xs-3">Email Adresi:</label>
                    <div class="col-sm-8 col-xs-9">
                        <input type="text" id="email" name="email" value="{{ Input::old('email') ? Input::old('email') : $abone->email }}" maxlength="100" class="form-control">
                    </div>
                </div>
                <div class="form-group col-sm-6 col-xs-12">
                    <label class="control-label col-sm-4 col-xs-3">İl:<span class="required" aria-required="true"> * </span></label>
                    <div class="input-icon right col-sm-8 col-xs-9">
                        <i class="fa"></i><select class="form-control select2me select2-offscreen" id="il" name="il" tabindex="-1" title="">
                            <option value="">Seçiniz...</option>
                            @foreach($iller as $il)
                                @if((Input::old('il') ? Input::old('il') : $abone->iller_id)==$il->id )
                ...
                <div class="form-group col-sm-6 col-xs-12">
                    <label class="control-label col-sm-4 col-xs-3">İlçe:<span class="required" aria-required="true"> * </span></label>
                    <div class="input-icon right col-sm-8 col-xs-9">
                        <i class="fa"></i><select class="form-control select2me select2-offscreen" id="ilce" name="ilce" tabindex="-1" title="">
                            <option value="">Seçiniz...</option>
                            @foreach($ilceler as $ilce)
                                @if((Input::old('ilce') ? Input::old('ilce') : $abone->ilceler_id)==$ilce->id )
                ...
                <div class="form-group">
                    ...
                    <label class="col-xs-2 count" style="padding-top: 9px">{{Input::old('count') ? Input::old('count') : count($abonesayaclari) .' Adet'}}</label>
                    <input type="text" id="count" name="count" value="{{Input::old('count') ? Input::old('count') : count($abonesayaclari)}}" data-required="1" class="form-control hide">
                ...
                <div class="panel-group accordion sayaclar col-xs-12" id="accordion1">
                    @if((Input::old('count') ? (int)(Input::old('count')) : $abonesayaclari->count())!=0)
                        @for($i=0;$i<(Input::old('count') ? (int)(Input::old('count')) : $abonesayaclari->count());$i++)
                        <div class="panel panel-default sayaclar_ek"><input class="no hide" value="{{$i}}"/><input class="adet hide" value="1"/>
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a class="accordion-toggle accordion-toggle-styled" data-toggle="collapse" data-parent="#accordion1" href="#collapse_{{$i}}">{{Input::old('serino.'.$i) ? Input::old('serino.'.$i) : $abonesayaclari[$i]->serino}} </a>
                                </h4>
                            </div>
                                ...
                                <div class="panel-body">
                                    <div class="form-group col-xs-12">
                                        ...
                                        <div class="input-icon right col-sm-4 col-xs-6">
                                            <i class="fa"></i><input type="text" id="serino{{$i}}" name="serino[{{$i}}]" maxlength="15" class="form-control valid{{$i}} serino" value="{{Input::old('serino.'.$i.'') ? Input::old('serino.'.$i) : $abonesayaclari[$i]->serino}}" />
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-icon right col-sm-4 col-xs-8">
                                            <i class="fa"></i><select class="form-control select2me valid{{$i}} sayactur sayactur{{$i}}" id="sayactur{{$i}}" name="sayacturleri[{{$i}}]" tabindex="-1" title="">
                                                <option value="">Seçiniz...</option>
                                                @foreach($sayacturleri as $sayactur)
                                                    @if((Input::old('sayacturleri.'.$i.'') ? Input::old('sayacturleri.'.$i) : $abonesayaclari[$i]->sayactur_id)==$sayactur->id)
                                    ...
                                    <div class="form-group col-sm-6 col-xs-12">
                                        ...
                                        <div class="input-icon right col-xs-8">
                                            <i class="fa"></i><select class="form-control select2me valid{{$i}} sayacadi sayacadi{{$i}}" id="sayacadi{{$i}}" name="sayacadlari[{{$i}}]" tabindex="-1" title="">
                                                <option value="">Seçiniz...</option>
                                                @foreach($sayacadlari as $sayacadi)
                                                    @if((Input::old('sayacadlari.'.$i.'') ? Input::old('sayacadlari.'.$i) : $abonesayaclari[$i]->sayacadi_id)==$sayacadi->id)
                                    ...
                                    <div class="form-group col-sm-6 col-xs-12">
                                        ...
                                        <div class="input-icon right col-xs-8">
                                            <i class="fa"></i><select class="form-control select2me valid{{$i}} sayaccap sayaccap{{$i}}" id="sayaccap{{$i}}" name="sayaccap[{{$i}}]" tabindex="-1" title="">
                                                @foreach($sayaccaplari as $sayaccapi)
                                                    @if((Input::old('sayaccaplari.'.$i.'') ? Input::old('sayaccaplari.'.$i) : (isset($abonesayaclari[$i]) ? $abonesayaclari[$i]->sayaccap_id : 1 ))==$sayaccapi->id)
                                    ...
                                    <div class="form-group col-xs-12">
                                        ...
                                        <div class="input-icon right col-sm-10 col-xs-8">
                                            <i class="fa"></i><input type="text" id="sayacadresi{{$i}}" name="sayacadresi[{{$i}}]" class="form-control valid{{$i}} sayacadresi" value="{{Input::old('sayacadresi.'.$i.'') ? Input::old('sayacadresi.'.$i) : $abonesayaclari[$i]->adres}}">
                                        </div>
                                    </div>
                                    <div class="form-group col-sm-6 col-xs-12">
                                        <label class="col-xs-4 control-label">Bilgi:</label>
                                        <div class="col-xs-8">
                                            <input type="text" id="sayacbilgi{{$i}}" name="sayacbilgi[{{$i}}]" class="form-control sayacbilgi" value="{{Input::old('sayacbilgi.'.$i.'') ? Input::old('sayacbilgi.'.$i) : (isset($abonesayaclari[$i]) ? $abonesayaclari[$i]->bilgi : '')}}" >
                                        </div>
                                    </div>
                                    <div class="form-group col-sm-6 col-xs-12">
                                        <label class="col-xs-4 control-label">İletişim:</label>
                                        <div class="col-xs-8">
                                            <input type="text" id="sayaciletisim{{$i}}" name="sayaciletisim[{{$i}}]" class="form-control sayaciletisim" value="{{Input::old('sayaciletisim.'.$i.'') ? Input::old('sayaciletisim.'.$i) : (isset($abonesayaclari[$i]) ? $abonesayaclari[$i]->iletisim : '')}}" >
                                        </div>
                                    </div>
                                </div>
                            </div>
