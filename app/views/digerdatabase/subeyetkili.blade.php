...
@section('page-title')
    <div class="page-title">
        <h1>Şube <small>Yetkili Eleman Bilgi Ekranı</small></h1>
    </div>
@stop
...
@section('scripts')
    ...
    <script>
        ...
        var oTable = table.DataTable({
            ...
            "bProcessing": true,
            "ajax": {
                "url": "{{ URL::to('digerdatabase/subeyetkililist') }}",
                "type": "POST",
                "data": {
                }
            },
            ...
            "columns": [
                {data: 'id', name: 'subeyetkili.id',"class":"id","orderable": true, "searchable": true},
                ...
                {data: 'subekodu', name: 'subeyetkili.subekodu',"orderable": true, "searchable": true},
                {data: 'gaktif', name: 'subeyetkili.gaktif',"orderable": true, "searchable": false},
                ...
                {data: 'naktif', name: 'subeyetkili.naktif',"visible": false, "searchable": true},
        ...
        $('<label>Kriter: </label><select style="height: 34px;margin-left: 5px;border-radius: 4px;padding-top:2px;padding-right: 10px" id="kriter" tabindex="-1" title="" class="select2me">'+
            ...
            '<option value="6">Cari Bilgisi</option>'+
            '<option value="3">Şube Kodu</option>'+
            '<option value="7">Durum</option>'+
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-tag"></i>Şube Yetkili Kişiler
                    </div>
                    <div class="actions">
                        <a href="{{ URL::to('digerdatabase/subeyetkiliekle') }}" class="btn btn-default btn-sm">
                            <i class="fa fa-pencil"></i> Şube Yetkili Eleman Ekle </a>
                    </div>
                </div>
