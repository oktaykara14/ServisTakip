...
@section('page-title')
    <div class="page-title">
        <h1>Netsis Cari Kasa Tanımları <small> Bilgi Ekranı</small></h1>
    </div>
@stop
...
@section('scripts')
    ...
    <script>
        ...
        var oTable = table.DataTable({
            ...
            "bProcessing": true,
            "ajax": {
                "url": "{{ URL::to('digerdatabase/kasakodlist') }}",
                "type": "POST",
                "data": {
                }
            },
            ...
            "columns": [
                {data: 'id', name: 'kasakod.id',"class":"id","orderable": true, "searchable": true},
                {data: 'kasakod', name: 'kasakod.kasakod',"orderable": true, "searchable": false},
                {data: 'kasaadi', name: 'kasakod.kasaadi',"orderable": true, "searchable": false},
                ...
                {data: 'godemetipi', name: 'kasakod.godemetipi',"orderable": true, "searchable": false},
                {data: 'nkasakod', name: 'kasakod.nkasakod',"visible": false, "searchable": true},
                {data: 'nkasaadi', name: 'kasakod.nkasaadi',"visible": false, "searchable": true},
                ...
                {data: 'nodemetipi', name: 'kasakod.nodemetipi',"visible": false, "searchable": true},
        ...
        $('<label>Kriter: </label><select style="height: 34px;margin-left: 5px;border-radius: 4px;padding-top:2px;padding-right: 10px" id="kriter" tabindex="-1" title="" class="select2me">'+
            ...
            '<option value="6">Kasa Kodu</option>'+
            '<option value="7">Kasa Adı</option>'+
            '<option value="8">Şube</option>'+
            '<option value="9">Cari Adı</option>'+
            '<option value="10">Ödeme Tipi</option>'+
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-tag"></i>Netsis Kasa Tanım Bilgileri
                    </div>
                    <div class="actions">
                    </div>
                </div>
