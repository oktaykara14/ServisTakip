...
@section('content')
    <div class="portlet box">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-pencil"></i>Şube Yetkili Eleman Bilgi Düzenleme
            </div>
        </div>
        <div class="portlet-body form">
            <!-- BEGIN FORM-->
            <form action="{{ URL::to('digerdatabase/subeyetkiliduzenle/'.$subeyetkili->id.'') }}" id="form_sample" method="POST" class="form-horizontal" novalidate="novalidate">
                <div class="form-body">
                        ...
                        <div class="input-icon right col-sm-9 col-xs-8">
                            <i class="fa"></i><select class="form-control select2me select2-offscreen" id="kullanici" name="kullanici" tabindex="-1" title="">
                                ...
                                @foreach($kullanicilar as $kullanici)
                                    @if((Input::old('kullanici') ? Input::old('kullanici') : $subeyetkili->kullanici_id)==$kullanici->id )
                    ...
                    <div class="form-group col-sm-6 col-xs-12">
                        ...
                        <div class="col-xs-8">
                            <input type="text" id="email" name="email" value="{{Input::old('email')?Input::old('email'):$subeyetkili->email }}" data-required="1" class="form-control">
                        </div>
                    </div>
                    <div class="form-group col-sm-6 col-xs-12">
                        <label class="control-label col-xs-4">Telefon:</label>
                        <div class="col-xs-8">
                            <input type="text" id="telefon" name="telefon" value="{{Input::old('telefon')?Input::old('telefon'):$subeyetkili->telefon }}" data-required="1" class="form-control">
                        </div>
                    </div>
                    <div class="form-group col-xs-12">
                        ...
                        <div class="input-icon right col-sm-9 col-xs-8">
                            <i class="fa"></i><select class="form-control select2me select2-offscreen" id="netsiscari" name="netsiscari" tabindex="-1" title="">
                                ...
                                @foreach($netsiscariler as $netsiscari)
                                    @if((Input::old('netsiscari')?Input::old('netsiscari'):$subeyetkili->netsiscari_id)==$netsiscari->id )
                        ...
                        <div class="input-icon right col-xs-8">
                            <i class="fa"></i><select class="form-control select2me select2-offscreen" id="subekod" name="subekod" tabindex="-1" title="">
                                ...
                                @foreach($subekodlari as $subekod)
                                    @if((Input::old('subekod') ? Input::old('subekod') : $subeyetkili->subekodu )==$subekod->SUBE_KODU )
                        ...
                        <div class="input-icon right col-xs-8">
                            <i class="fa"></i><select class="form-control select2me select2-offscreen" id="projekodu" name="projekodu" tabindex="-1" title="">
                                ...
                                @foreach($projekodlari as $projekodu)
                                    @if((Input::old('projekodu') ? Input::old('projekodu') : $subeyetkili->projekodu)==$projekodu->PROJE_KODU )
                    ...
                    <div class="form-group col-sm-6 col-xs-12">
                        ...
                        <div class="input-icon right col-xs-8">
                            <i class="fa"></i><input type="text" id="belgeonek" name="belgeonek" value="{{Input::old('belgeonek')?Input::old('belgeonek'):$subeyetkili->belgeonek }}" maxlength="1" data-required="1" class="form-control">
                        </div>
                    </div>
                    <div class="form-group col-sm-6 col-xs-12">
                        ...
                        <div class="input-icon right col-xs-8">
                            <i class="fa"></i><select class="form-control select2me select2-offscreen" id="durum" name="durum" tabindex="-1" title="">
                                <option value="">Seçiniz...</option>
                                <option value="0" {{ (Input::old('durum')?Input::old('durum'):$subeyetkili->aktif)==0 ? 'selected' : '' }}>Pasif</option>
                                <option value="1" {{ (Input::old('durum')?Input::old('durum'):$subeyetkili->aktif)==1 ? 'selected' : '' }}>Aktif</option>
                            </select>
                        </div>
                    </div>
