...
@section('page-title')
    <div class="page-title">
        <h1>Servis Yetkili <small>Düzenleme Ekranı</small></h1>
    </div>
@stop
...
@section('content')
    <div class="portlet box">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-pencil"></i>Servis Yetkili Bilgi Düzenleme
            </div>
        </div>
        <div class="portlet-body form">
            <!-- BEGIN FORM-->
            <form action="{{ URL::to('digerdatabase/servisyetkiliduzenle/'.$servisyetkili->id.'') }}" id="form_sample" method="POST" class="form-horizontal" novalidate="novalidate">
                <div class="form-body">
                        ...
                        <div class="input-icon right col-xs-8">
                            <i class="fa"></i><select class="form-control select2me select2-offscreen" id="kullanici" name="kullanici" tabindex="-1" title="">
                                ...
                                @foreach($kullanicilar as $kullanici)
                                    @if((Input::old('kullanici') ? Input::old('kullanici') : $servisyetkili->kullanici_id )==$kullanici->id )
                        ...
                        <div class="input-icon right col-xs-8">
                            <i class="fa"></i><select class="form-control select2me select2-offscreen" id="plasiyer" name="plasiyer" tabindex="-1" title="">
                                ...
                                @foreach($plasiyerler as $plasiyer)
                                    @if((Input::old('plasiyer') ? Input::old('plasiyer') : $servisyetkili->plasiyerkod )==$plasiyer->kodu )
                        ...
                        <div class="input-icon right col-xs-8">
                            <i class="fa"></i><select class="form-control select2me select2-offscreen" id="ozelkod" name="ozelkod" tabindex="-1" title="">
                                ...
                                @foreach($ozelkodlar as $ozelkod)
                                    @if((Input::old('ozelkod') ? Input::old('ozelkod') : $servisyetkili->ozelkod )==$ozelkod->OZELKOD )
                        ...
                        <div class="input-icon right col-xs-8">
                            <i class="fa"></i><select class="form-control select2me select2-offscreen" id="depo" name="depo" tabindex="-1" title="">
                                ...
                                @foreach($depolar as $depo)
                                    @if((Input::old('depo') ? Input::old('depo') : $servisyetkili->depokodu )==$depo->kodu )
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-icon right col-xs-8">
                            <i class="fa"></i><input type="text" id="netsiskullanici" name="netsiskullanici" value="{{ (Input::old('netsiskullanici') ? Input::old('netsiskullanici') : $servisyetkili->netsiskullanici ) }}" data-required="1" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-2 col-xs-4">Netsis Kullanıcı No: <span class="required" aria-required="true"> * </span></label>
                        <div class="input-icon right col-xs-8">
                            <i class="fa"></i><input type="text" id="netsiskullanicino" name="netsiskullanicino" value="{{Input::old('netsiskullanicino')? Input::old('netsiskullanicino') : $servisyetkili->netsiskullanici_id }}" data-required="1" class="form-control">
                        </div>
                    </div>
