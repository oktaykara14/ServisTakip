...
<div class="page-title">
    <h1>Servis <small>Durum Bilgi Ekranı</small></h1>
</div>
@stop
...
@section('scripts')
    ...
    <script>
        ...
        var oTable = table.DataTable({
            ...
            "bProcessing": true,
            "ajax": {
                "url": "{{ URL::to('digerdatabase/durumlist') }}",
                "type": "POST",
                "data": {
                }
            },
            ...
            "columns": [
                {data: 'id', name: 'sayacdurum.id',"class":"id","orderable": true, "searchable": true},
                {data: 'durumadi', name: 'sayacdurum.durumadi',"orderable": true, "searchable": false},
                {data: 'gozel', name: 'sayacdurum.gozel',"orderable": true, "searchable": false},
                {data: 'ndurumadi', name: 'sayacdurum.ndurumadi',"visible": false, "searchable": true},
                {data: 'nozel', name: 'sayacdurum.nozel',"visible": false, "searchable": true},
    ...
    $(document).on("click", ".delete", function () {
         var id = $(this).data('id');
         $(".modal-footer #sayacid").attr('href',"{{ URL::to('digerdatabase/durumsil') }}/"+id );
    });
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-tag"></i>Sistemdeki Durumlar
                    </div>
                    <div class="actions">
                        <a href="{{ URL::to('digerdatabase/durumekle') }}" class="btn btn-default btn-sm">
                            <i class="fa fa-pencil"></i> Yeni Durum Ekle </a>
                    </div>
                </div>
        ...
        <div class="modal-dialog">
                <div class="modal-content">
                        <div class="modal-header">
                                ...
                                <h4 class="modal-title">Servis Durumu Silinecek</h4>
                        </div>
                        <div class="modal-body">
                                 Seçilen Servis Durumunu Silmek İstediğinizden Emin Misiniz?
                        </div>
