...
<div class="page-title">
    <h1>Servis <small>Sayaç Markaları Bilgi Ekranı</small></h1>
</div>
@stop
...
@section('scripts')
    ...
    <script>
        ...
        var oTable = table.DataTable({
            ...
            "bProcessing": true,
            "ajax": {
                "url": "{{ URL::to('digerdatabase/markalist') }}",
                "type": "POST",
                "data": {
                }
            },
            ...
            "columns": [
                {data: 'id', name: 'sayacmarka.id',"class":"id","orderable": true, "searchable": true},
    ...
    $(document).on("click", ".delete", function () {
         var id = $(this).data('id');
         $(".modal-footer #sayacid").attr('href',"{{ URL::to('digerdatabase/markasil') }}/"+id );
    });
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-tag"></i>Sayaç Markaları
                    </div>
                    <div class="actions">
                        <a href="{{ URL::to('digerdatabase/markaekle') }}" class="btn btn-default btn-sm">
                            <i class="fa fa-pencil"></i> Yeni Sayaç Markası Ekle </a>
                    </div>
                </div>
        ...
        <div class="modal-dialog">
                <div class="modal-content">
                        <div class="modal-header">
                                ...
                                <h4 class="modal-title">Sayac Markası Silinecek</h4>
                        </div>
                        <div class="modal-body">
                                 Seçilen Sayaç Markasını Silmek İstediğinizden Emin Misiniz?
                        </div>
