...
<div class="page-title">
    <h1>Servis <small>Sayaç Türleri Bilgi Ekranı</small></h1>
</div>
@stop
...
@section('scripts')
    ...
    <script>
        ...
        var oTable = table.DataTable({
            ...
            "bProcessing": true,
            "ajax": {
                "url": "{{ URL::to('digerdatabase/turlist') }}",
                "type": "POST",
                "data": {
                }
            },
            ...
            "columns": [
                {data: 'id', name: 'sayactur.id',"class":"id","orderable": true, "searchable": true},
        ...
        $('<label>Kriter: </label><select style="height: 34px;margin-left: 5px;border-radius: 4px;padding-top:2px;padding-right: 10px" id="kriter" tabindex="-1" title="" class="select2me">'+
            ...
            '<option value="2">Sayaç Türü</option>'+
    ...
    $(document).on("click", ".delete", function () {
         var id = $(this).data('id');
         $(".modal-footer #sayacid").attr('href',"{{ URL::to('digerdatabase/tursil') }}/"+id );
    });
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-tag"></i>Sayaç Türleri
                    </div>
                    <div class="actions">
                        <a href="{{ URL::to('digerdatabase/turekle') }}" class="btn btn-default btn-sm">
                            <i class="fa fa-pencil"></i> Yeni Sayaç Türü Ekle </a>
                    </div>
                </div>
        ...
        <div class="modal-dialog">
                <div class="modal-content">
                        <div class="modal-header">
                                ...
                                <h4 class="modal-title">Sayac Türü Silinecek</h4>
                        </div>
                        <div class="modal-body">
                                 Seçilen Sayaç Türü Silmek İstediğinizden Emin Misiniz?
                        </div>
