...
@section('page-title')
    <div class="page-title">
        <h1>Netsis Cari - Üretim Yeri Eşleştirme <small> Bilgi Ekranı</small></h1>
    </div>
@stop
...
@section('scripts')
    ...
    <script>
        ...
        var oTable = table.DataTable({
            ...
            "bProcessing": true,
            "ajax": {
                "url": "{{ URL::to('digerdatabase/cariyerlist') }}",
                "type": "POST",
                "data": {
                }
            },
            ...
            "columns": [
                {data: 'id', name: 'cariyer.id',"class":"id","orderable": true, "searchable": true},
                ...
                {data: 'gdurum', name: 'cariyer.gdurum',"orderable": true, "searchable": false},
                {data: 'updated_at', name: 'cariyer.updated_at',"orderable": true, "searchable": false},
                {data: 'gdurumtarihi', name: 'cariyer.gdurumtarihi',"visible": false, "searchable": true},
                ...
                {data: 'ndurum', name: 'cariyer.ndurum',"visible": false, "searchable": true},
        ...
        $('<label>Kriter: </label><select style="height: 34px;margin-left: 5px;border-radius: 4px;padding-top:2px;padding-right: 10px" id="kriter" tabindex="-1" title="" class="select2me">'+
            ...
            '<option value="7">Yer Adı</option>'+
            '<option value="8">Cari Adı</option>'+
            '<option value="9">Kullanıcı</option>'+
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-tag"></i>Netsis Cari ve Üretim Yeri Bilgileri
                    </div>
                    <div class="actions">
                        <a href="{{ URL::to('digerdatabase/cariyerekle') }}" class="btn btn-default btn-sm">
                            <i class="fa fa-pencil"></i> Yeni Eşleştirme Ekle </a>
                    </div>
                </div>
