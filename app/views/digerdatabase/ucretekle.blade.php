...
<div class="page-title">
    <h1>Toplu Sayaç Parça Ücreti <small>Ekleme Ekranı</small></h1>
</div>
@stop
                    ...
                    if (event.durum) {
                        ...
                        for (key = 0, size = sayacparca.length; key < size; key++) {
                            ...
                            if(sayacparca[key]['ozel']!==null)
                                ...
                                r[++j] = '<input type="tel" id="ozelbirim'+value+'" class="ozelbirim" name="ozel[]" value="' + (parseFloat('0.00').toFixed(2)) + '" style="background-color: green;color:white"/>';
                            r[++j] = '</td></tr>';
                        }
...
<div class="portlet box">
    <div class="portlet-title">
        <div class="caption">
            <i class="fa fa-plus"></i>Toplu Sayaç Parça Ücreti Ekle
        </div>
    </div>
    <div class="portlet-body form">
        <!-- BEGIN FORM-->
        <form action="{{ URL::to('digerdatabase/ucretekle') }}" id="form_sample" method="POST" class="form-horizontal" novalidate="novalidate">
            <div class="form-body">
                ...
                <div class="form-group hide">
                    ...
                    <input id="ozelbirim" name="ozelbirim" value="{{ Input::old('ozelbirim') }}"/>
