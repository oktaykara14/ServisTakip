...
<div class="page-title">
    <h1>Şube <small>Ekleme Ekranı</small></h1>
</div>
@stop
...
<div class="portlet box">
    <div class="portlet-title">
        <div class="caption">
            <i class="fa fa-plus"></i>Şube Ekle
        </div>
    </div>
    <div class="portlet-body form">
        <!-- BEGIN FORM-->
        <form action="{{ URL::to('digerdatabase/subeekle') }}" id="form_sample" method="POST" class="form-horizontal" novalidate="novalidate">
            <div class="form-body">
                    ...
                    <div class="input-icon right col-xs-8">
                        <i class="fa"></i><select class="form-control select2me select2-offscreen" id="depo" name="depo" tabindex="-1" title="">
                            ...
                            @foreach($netsisdepolar as $netsisdepo)
                                @if(Input::old('depo')==$netsisdepo->id )
                ...
                <div class="form-group">
                    ...
                    <div class="input-icon right col-xs-6">
                        <i class="fa"></i><input type="text" id="linkedserver" name="linkedserver" value="{{Input::old('linkedserver') }}" data-required="1" class="form-control">
                    </div>
                    <div class="col-xs-2">
                        <a class="btn red test">Test Et</a><label class="linkeddurum" style="margin-left:5px;"></label>
                    </div>
                    <input id="linkeddurum" name="linkeddurum" class="hide" value="0">
                </div>
                <div class="form-group">
                    ...
                    <div class="input-icon right col-xs-6">
                        <i class="fa"></i><input type="text" id="linkedserverabone" name="linkedserverabone" value="{{Input::old('linkedserverabone') }}" data-required="1" class="form-control">
                    </div>
                    <div class="col-xs-2">
                        <a class="btn red testabone">Test Et</a><label class="linkedabonedurum" style="margin-left:5px;"></label>
                    </div>
                    <input id="linkedabonedurum" name="linkedabonedurum" class="hide" value="0">
                </div>
                <div class="form-group">
                    ...
                    <div class="input-icon right col-xs-8">
                        <i class="fa"></i><select class="form-control select2me select2-offscreen" id="aktif" name="aktif" tabindex="-1" title="">
                            <option value="0" {{(Input::old('aktif'))==0 ? 'selected' : ''}}>Pasif</option>
                            <option value="1" {{(Input::old('aktif'))==1 ? 'selected' : ''}}>Aktif</option>
                        </select>
                    </div>
                </div>
