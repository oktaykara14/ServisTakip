...
@section('page-title')
    <div class="page-title">
        <h1>Servis Yetkili <small> Bilgi Ekranı</small></h1>
    </div>
@stop
...
@section('scripts')
    ...
    <script>
        ...
        var oTable = table.DataTable({
            ...
            "bProcessing": true,
            "ajax": {
                "url": "{{ URL::to('digerdatabase/servisyetkililist') }}",
                "type": "POST",
                "data": {
                }
            },
            ...
            "columns": [
                {data: 'id', name: 'servisyetkili.id',"class":"id","orderable": true, "searchable": true},
                {data: 'adi_soyadi', name: 'kullanici.adi_soyadi',"orderable": true, "searchable": false},
                {data: 'plasiyerkod', name: 'servisyetkili.plasiyerkod',"orderable": true, "searchable": true},
                {data: 'plasiyeradi', name: 'plasiyer.plasiyeradi',"orderable": true, "searchable": false},
                {data: 'netsiskullanici', name: 'servisyetkili.netsiskullanici',"orderable": true, "searchable": false},
                {data: 'nadi_soyadi', name: 'kullanici.nadi_soyadi',"visible": false, "searchable": true},
                {data: 'nplasiyeradi', name: 'plasiyer.nplasiyeradi',"visible": false, "searchable": true},
                {data: 'nnetsiskullanici', name: 'servisyetkili.nnetsiskullanici',"visible": false, "searchable": true},
        ...
        $('<label>Kriter: </label><select style="height: 34px;margin-left: 5px;border-radius: 4px;padding-top:2px;padding-right: 10px" id="kriter" tabindex="-1" title="" class="select2me">'+
            ...
            '<option value="2">Plasiyer Kodu</option>'+
            '<option value="6">Plasiyer Bilgisi</option>'+
            '<option value="7">Netsis Kullanıcı Adı</option>'+
    ...
    <script>
        $(document).on("click", ".delete", function () {
            var id = $(this).data('id');
            $(".modal-footer #sayacid").attr('href',"{{ URL::to('digerdatabase/yetkilisil') }}/"+id);
        });
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-tag"></i>Servis Yetkili Kişiler
                    </div>
                    <div class="actions">
                        <a href="{{ URL::to('digerdatabase/servisyetkiliekle') }}" class="btn btn-default btn-sm">
                            <i class="fa fa-pencil"></i> Yeni Servis Yetkilisi Ekle </a>
                    </div>
                </div>
                <div class="portlet-body">
                    <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                        ...
                        <tr>
                            ...
                            <th>Kullanıcı</th>
                            <th>Plasiyer Kodu</th>
                            <th>Plasiyer Bilgisi</th>
                            <th>Netsis Kullanıcı Adı</th>
                            <th></th><th></th><th></th>
                            <th>İşlemler</th>
                        </tr>
                        </thead>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Servis Yetkilisi Silinecek</h4>
                </div>
                <div class="modal-body">
                    Servis Yetkilisini Silmek İstediğinizden Emin Misiniz?
                </div>
