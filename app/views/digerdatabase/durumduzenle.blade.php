...
<div class="page-title">
    <h1>Servis Durum <small>Bilgi Düzenleme Ekranı</small></h1>
</div>
@stop
...
<div class="portlet box">
    <div class="portlet-title">
        <div class="caption">
            <i class="fa fa-pencil"></i>Durum Düzenle
        </div>
    </div>
    <div class="portlet-body form">
        <!-- BEGIN FORM-->
        <form action="{{ URL::to('digerdatabase/durumduzenle/'.$sayacdurum->id.'') }}" id="form_sample_3" method="POST" class="form-horizontal" novalidate="novalidate">
            <div class="form-body">
                ...
                <div class="form-group">
                    ...
                    <div class="input-icon right col-xs-8">
                        <i class="fa"></i><input type="text" id="durum" name="durum" value="{{Input::old('durum') ? Input::old('durum') : $sayacdurum->durumadi }}" data-required="1" class="form-control">
                    </div>
                </div>
                <div class="form-group">
                        ...
                        <div class="col-xs-8">
                                <div class="bootstrap-switch bootstrap-switch-wrapper bootstrap-switch-off bootstrap-switch-animate" style="width: 126px;">
                                    ...
                                    <input type="checkbox" id="ozel" name="ozel" class="make-switch" data-on-color="success" data-off-color="warning" data-on-text="Ozel" data-off-text="Genel" @if(Input::old('ozel') ? Input::old('ozel') :$sayacdurum->ozel) checked @else  @endif>
                                    </div>
                                </div>
                        </div>
                </div>
