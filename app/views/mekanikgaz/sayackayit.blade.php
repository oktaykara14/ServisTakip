...
<div class="page-title">
    <h1>Gaz Servis Mekanik <small>Sayaç Kayıt Ekranı</small></h1>
</div>
@stop
...
@section('scripts')
    ...
    <script>
        ...
        var oTable = table.DataTable({
            ...
            "bProcessing": true,
            "ajax": {
                "url": "{{ URL::to('mekanikgaz/sayackayitlist') }}",
                "type": "POST",
                "data": {
            ...
            "fnDrawCallback" : function() {
                $(document).on("click", ".delete", function () {
                    var id = $(this).data('id');
                    $(".modal-footer #sayacid").attr('href',"{{ URL::to('mekanikgaz/sayackayitsil') }}/"+id);
                });
            },
            "aaSorting": [[6,'desc']],
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box">
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        <a href="{{ URL::to('mekanikgaz/sayackayitekle') }}" class="btn btn-default btn-sm">
