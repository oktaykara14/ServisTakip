...
<div class="page-title">
    <h1>Gaz Mekanik Sayaç Kayıt <small>Bilgi Ekranı</small></h1>
</div>
@stop
    ...
    <div class="portlet-body form">
        ...
        <form action="" id="form_sample" class="form-horizontal" novalidate="novalidate">
            <div class="form-body">
                ...
                <div class="form-group">
                    <label class="control-label col-sm-2 col-xs-4">Üretim Yılı:</label>
                    <label class="col-sm-3 col-xs-8" style="padding-top: 7px">{{date("Y", strtotime($sayacgelen->sayac->uretimtarihi))}}</label>
                </div>
                <div class="form-group">
            ...
            <div class="row">
                <div class="col-xs-12" style="text-align: center">
                    <a href="{{ URL::to('mekanikgaz/sayackayit')}}" class="btn default">Tamam</a>
                </div>
            </div>
            </div>
        </form>
