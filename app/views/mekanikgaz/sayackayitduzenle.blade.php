...
<div class="page-title">
    <h1>Gaz Mekanik Sayaç Kayıt <small>Düzenleme Ekranı</small></h1>
</div>
@stop
...
@section('page-script')
<script src="{{ URL::to('pages/mekanikgaz/form-validation-2.js') }}"></script>
@stop
...
<div class="portlet box">
    ...
    <div class="portlet-body form">
        <!-- BEGIN FORM-->
        <form action="{{ URL::to('mekanikgaz/sayackayitduzenle/'.$sayacgelen->id.'') }}" id="form_sample" method="POST" class="form-horizontal" novalidate="novalidate">
            <div class="form-body">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group col-sm-6 col-xs-12">
                        ...
                        <div class="input-icon right col-xs-8">
                            <i class="fa"></i><select class="form-control select2me select2-offscreen" id="uretimtarih" name="uretimtarih" tabindex="-1" title="">
                                <option value="" {{$sayacgelen->sayac->uretimtarihi==null ? 'selected' : ''}} >Seçiniz...</option>
                                @foreach($yillar as $yil)
                                    @if((Input::old('uretimtarih') ? Input::old('uretimtarih') : $sayacgelen->sayac->uretimtarihi!=null ? date("Y", strtotime($sayacgelen->sayac->uretimtarihi)) : '' )==$yil)
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <div class="input-icon right col-xs-8">
                            <i class="fa"></i><input type="text" id="serino" name="serino" value="{{ Input::old('serino') ? Input::old('serino') : $sayacgelen->serino }}" class="form-control serino" maxlength="20">
                        </div>
                    </div>
