...
<div class="page-title">
    <h1>Gaz Servis <small>Beyanname Ekranı</small></h1>
</div>
@stop
...
@section('scripts')
    ...
    <script>
        ...
        var oTable = table.DataTable({
            ...
            "bProcessing": true,
            "ajax": {
                "url": "{{ URL::to('mekanikgaz/beyannamelist') }}",
                "type": "POST",
                "data": {
                }
            },
            ...
            "fnDrawCallback" : function() {
                $(document).on("click", ".delete", function () {
                    var id = $(this).data('id');
                    $(".modal-footer #sayacid").attr('href',"{{ URL::to('mekanikgaz/beyannamesil') }}/"+id );
                });
            },
            "aaSorting": [[0,'desc']],
    ...
    <script>
        $('.beyanname').click(function() {
            ...
            if(beyanname !=null){
                ...
                var redirect = "";
                $.redirectPost(redirect, {beyanname: beyanname,rapor:'1',servis:'5',ireport:'1'});
            }
        });
        $('.defter').click(function() {
            ...
            if(beyanname !=null){
                ...
                var redirect = "";
                $.redirectPost(redirect, {beyanname: beyanname,rapor:'2',servis:'5',ireport:'1'});
            }
        });
            ...
            <div class="portlet box">
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        ...
                        <a href="{{ URL::to('mekanikgaz/beyannameekle') }}" class="btn btn-default btn-sm">
