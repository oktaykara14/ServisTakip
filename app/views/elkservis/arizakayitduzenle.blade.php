...
<div class="page-title">
    <h1>Elektrik Arıza Kayıt <small>Düzenleme Ekranı</small></h1>
</div>
@stop
...
<script>
    $(document).ready(function() {
        ...
        $('#sayacadi').on('change', function () {
            ...
            if (id !== "") {
                $.blockUI();
                $.getJSON("{{ URL::to('elkservis/sayacparca') }}",{sayacadiid:id,sayaccapid:1}, function (event) {
        ...
        $('.serinoekle').click(function () {
            ...
            if (yeniserino === "") {
                ...
                $.blockUI();
                $.getJSON("{{ URL::to('elkservis/serinoekle') }}", {yeniserino: yeniserino,uretimyer:uretimyer,sayactur:2,sayacadi:sayacadi,sayaccap:sayaccap,sayacgelen:sayacgelen}, function (event) {
                    toastr[event.type](event.text, event.title);
...
<div class="portlet box">
    ...
    <div class="portlet-body form">
        <!-- BEGIN FORM-->
        <form action="{{ URL::to('elkservis/arizakayitduzenle/'.$arizakayit->id.'') }}" id="form_sample" method="POST" class="form-horizontal" novalidate="novalidate" enctype="multipart/form-data">
            <div class="form-body">
                ...
                <div class="form-group col-sm-6 col-xs-12">
                    <label class="control-label col-sm-4 col-xs-3">T1 Tüketimi:<span class="required" aria-required="true"> * </span></label>
                    <div class="input-icon right col-sm-8 col-xs-9">
                        <i class="fa"></i><input type="text" id="t1deger" name="t1deger" value="{{ Input::old('t1deger') ? Input::old('t1deger') : round($arizakayit->ilkkredi,3) }}" maxlength="14" data-required="1" class="form-control" tabindex="6">
                    </div>
                </div>
                <div class="form-group col-sm-6 col-xs-12">
                    <label class="control-label col-sm-4 col-xs-3">T2 Tüketimi:<span class="required" aria-required="true"> * </span></label>
                    <div class="input-icon right col-sm-8 col-xs-9">
                        <i class="fa"></i><input type="text" id="t2deger" name="t2deger" value="{{ Input::old('t2deger') ? Input::old('t2deger') : round($arizakayit->ilkharcanan,3) }}" maxlength="14" data-required="1" class="form-control" tabindex="7">
                    </div>
                </div>
                <div class="form-group col-sm-6 col-xs-12">
                    <label class="control-label col-sm-4 col-xs-3">T3 Tüketimi:<span class="required" aria-required="true"> * </span></label>
                    <div class="input-icon right col-sm-8 col-xs-9">
                        <i class="fa"></i><input type="text" id="t3deger" name="t3deger" value="{{ Input::old('t3deger') ? Input::old('t3deger') : round($arizakayit->ilkmekanik,3) }}" maxlength="14" data-required="1" class="form-control" tabindex="8">
                    </div>
                </div>
                <div class="form-group col-sm-6 col-xs-12">
                ...
                <div class="form-group col-sm-6 col-xs-12">
                    ...
                    <div class="input-icon right col-sm-8 col-xs-9">
                        <i class="fa"></i><input type="text" id="ttoplam" name="ttoplam" value="{{ Input::old('ttoplam') ? Input::old('ttoplam') : round($arizakayit->harcanankredi,3) }}" maxlength="14" data-required="1" class="form-control" tabindex="10">
                    </div>
                </div>
                <div class="form-group col-sm-6 col-xs-12">
                    <label class="control-label col-sm-4 col-xs-3">Kalan Kredi:<span class="required" aria-required="true"> * </span></label>
                    <div class="input-icon right col-sm-8 col-xs-9">
                        <i class="fa"></i><input type="text" id="kalankredi" name="kalankredi" value="{{ Input::old('kalankredi') ? Input::old('kalankredi') : round($arizakayit->mekanik,3) }}" maxlength="14" data-required="1" class="form-control" tabindex="11">
                    </div>
                </div>
                <div class="form-group col-xs-12">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8 col-xs-7">
                        <input type="text" id="arizanot" name="arizanot" value="{{ Input::old('arizanot') ? Input::old('arizanot') : $arizakayit->arizanot }}" data-required="1" class="form-control" tabindex="22">
                    </div>
                </div>
                                ...
                                <form action="" id="form_sample_2" class="form-horizontal" novalidate="novalidate">
                                    <div class="form-body">
                                        ...
                                        <div class="form-group col-sm-6 col-xs-12">
                                            ...
                                            <label class="col-xs-12 eskigaranti" style="padding-top: 9px"></label>
                                        </div>
                                        <div class="form-group col-sm-6 col-xs-12">
                                        ...
                                        <div class="form-group col-xs-12">
                                            <label class="control-label col-xs-2">Kayıt Yapan:</label>
