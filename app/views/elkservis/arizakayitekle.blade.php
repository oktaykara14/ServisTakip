...
<div class="page-title">
    <h1>Elektrik Arıza Kayıt <small>Ekleme Ekranı</small></h1>
</div>
@stop
...
@section('page-script')
<script src="{{ URL::to('pages/elkservis/form-validation-3.js') }}"></script>
@stop
...
var oTable = table.DataTable({
    ...
    "fnDrawCallback" : function() {
        $('.goster').click(function(){
            ...
            if(sayacid!=="") {
                $.blockUI();
                $.getJSON("{{ URL::to('elkservis/gelisbilgidetay') }}",{sayacid:sayacid,depoteslimid:depoteslimid}, function (event) {
                    if(event.durum){
                        ...
                        $('.eskit1').html(arizakayit.ilkkredi);
                        $('.eskit2').html(arizakayit.ilkharcanan);
                        $('.eskit3').html(arizakayit.ilkmekanik);
                        $('.eskit4').html(arizakayit.kalankredi);
                        $('.eskitt').html(arizakayit.harcanankredi);
                        $('.eskikalan').html(arizakayit.mekanik);
    ...
    $(document).ready(function() {
        ...
        $('.getir').click(function () {
            ...
            if (serino !== "") {
                $.blockUI();
                var sayacgelenler;
                $.getJSON("{{ URL::to('elkservis/sayacbilgi') }}",{serino:serino}, function (event) {
                    if (event.durum === 0) // sayac bilgisini ekrana bas
                    {
                        ...
                        if (sayac.uretimyer_id === uretimyer.id) //bilgiler doğruysa
                        {
                            ...
                            $("#arizalar").valid();
                            $.getJSON("{{ URL::to('elkservis/sayacparca') }}",{sayacadiid:sayacgelen.sayacadi_id,sayaccapid:sayacgelen.sayaccap_id}, function (event) {
        ...
        $('.gelisbilgigetir').click(function () {
            ...
            if (sayacid !== "") {
                $.blockUI();
                $.getJSON("{{ URL::to('elkservis/gelisbilgi') }}",{sayacid:sayacid,cariid:cariid}, function (event) {
                    if(event.durum){
                        oTable.clear().draw();
        ...
        $('#sayacadi').on('change', function () {
            ...
            if (id !== "") {
                $.blockUI();
                $.getJSON("{{ URL::to('elkservis/sayacparca') }}",{sayacadiid:id}, function (event) {
                    if (event.durum) //sayaç parçalarını listede göster
                    {
                        var parcalar = event.sayacparcalar.parca;
                        $("#degisenler").empty();
        ...
        if (serino !== "") {
            ...
            var sayacgelenler;
            if(sayacid !== "" ){
                $.getJSON("{{ URL::to('elkservis/sayacbilgi') }}",{serino:serino,sayacid:sayacid}, function (event) {
                    if (event.durum === 0) // sayac bilgisini ekrana bas
                    {
                        var sayacgelen = event.sayacgelenler[0];
                        var netsiscari = sayacgelen.netsiscari;
        ...
        var t1 = parseFloat(($('#t1deger').val().replace('.', '')).replace(',', '.'));
        var t2 = parseFloat(($('#t2deger').val().replace('.', '')).replace(',', '.'));
        var t3 = parseFloat(($('#t3deger').val().replace('.', '')).replace(',', '.'));
        var t4 = parseFloat(($('#t4deger').val().replace('.', '')).replace(',', '.'));
        ...
        $('#t1deger').on('change', function () {
            var t1 = parseFloat(($(this).val().replace('.', '')).replace(',', '.'));
            var t2 = parseFloat(($('#t2deger').val().replace('.', '')).replace(',', '.'));
            var t3 = parseFloat(($('#t3deger').val().replace('.', '')).replace(',', '.'));
            var t4 = parseFloat(($('#t4deger').val().replace('.', '')).replace(',', '.'));
            var toplam = parseFloat((isNaN(t1) ? 0 : t1) + (isNaN(t2) ? 0 : t2) + (isNaN(t3) ? 0 : t3) + (isNaN(t4) ? 0 : t4)).toFixed(3);
        ...
        $('#t2deger').on('change', function () {
            var t2 = parseFloat(($(this).val().replace('.', '')).replace(',', '.'));
            var t1 = parseFloat(($('#t1deger').val().replace('.', '')).replace(',', '.'));
            var t3 = parseFloat(($('#t3deger').val().replace('.', '')).replace(',', '.'));
            var t4 = parseFloat(($('#t4deger').val().replace('.', '')).replace(',', '.'));
            var toplam = parseFloat((isNaN(t1) ? 0 : t1) + (isNaN(t2) ? 0 : t2) + (isNaN(t3) ? 0 : t3) + (isNaN(t4) ? 0 : t4)).toFixed(3);
        ...
        $('#t3deger').on('change', function () {
            var t3 = parseFloat(($(this).val().replace('.', '')).replace(',', '.'));
            var t2 = parseFloat(($('#t2deger').val().replace('.', '')).replace(',', '.'));
            var t1 = parseFloat(($('#t1deger').val().replace('.', '')).replace(',', '.'));
            var t4 = parseFloat(($('#t4deger').val().replace('.', '')).replace(',', '.'));
            var toplam = parseFloat((isNaN(t1) ? 0 : t1) + (isNaN(t2) ? 0 : t2) + (isNaN(t3) ? 0 : t3) + (isNaN(t4) ? 0 : t4)).toFixed(3);
        ...
        $('#t4deger').on('change', function () {
            var t4 = parseFloat(($(this).val().replace('.', '')).replace(',', '.'));
            var t2 = parseFloat(($('#t2deger').val().replace('.', '')).replace(',', '.'));
            var t3 = parseFloat(($('#t3deger').val().replace('.', '')).replace(',', '.'));
            var t1 = parseFloat(($('#t1deger').val().replace('.', '')).replace(',', '.'));
            var toplam = parseFloat((isNaN(t1) ? 0 : t1) + (isNaN(t2) ? 0 : t2) + (isNaN(t3) ? 0 : t3) + (isNaN(t4) ? 0 : t4)).toFixed(3);
        ...
        $('#ekleneceklistesec').click(function () {
            ...
            var serino = $('#serino').val();
            $.blockUI();
            $.getJSON("{{ URL::to('elkservis/sayacgelenbilgi') }}",{serino:serino,sayacgelenid:sayacgelen_id}, function (event) {
        ...
        $('.arizaekle').click(function () {
            ...
            if (ariza === "") {
                ...
                $.blockUI();
                $.getJSON(" {{ URL::to('elkservis/arizaekle') }}", {ariza: ariza}, function (event) {
                    toastr[event.type](event.text, event.title);
        ...
        $('.yapilanekle').click(function () {
            ...
            if (yapilan === "") {
                ...
                $.blockUI();
                $.getJSON(" {{ URL::to('elkservis/yapilanekle') }}", {yapilan: yapilan}, function (event) {
                    toastr[event.type](event.text, event.title);
        ...
        $('.uyariekle').click(function () {
            ...
            if (uyari === "") {
                ...
                $.blockUI();
                $.getJSON(" {{ URL::to('elkservis/uyariekle') }}", {uyari: uyari}, function (event) {
                    toastr[event.type](event.text, event.title);
        ...
        $('.hurdanedeniekle').click(function () {
            ...
            if (hurdaneden === "") {
                ...
                $.blockUI();
                $.getJSON(" {{ URL::to('elkservis/hurdanedeniekle') }}", {hurdaneden: hurdaneden}, function (event) {
                    toastr[event.type](event.text, event.title);
        ...
        $('.serinoekle').click(function () {
            ...
            if (yeniserino === "") {
                ...
                $.blockUI();
                $.getJSON("{{ URL::to('elkservis/serinoekle') }}", {yeniserino: yeniserino,uretimyer:uretimyer,sayactur:2,sayacadi:sayacadi,sayaccap:sayaccap}, function (event) {
                    toastr[event.type](event.text, event.title);
...
<div class="portlet box">
    ...
    <div class="portlet-body form">
        <!-- BEGIN FORM-->
        <form action="{{ URL::to('elkservis/arizakayitekle') }}" id="form_sample" method="POST" class="form-horizontal" novalidate="novalidate" enctype="multipart/form-data">
            <div class="form-body">
                ...
                <div class="form-group col-xs-12">
                    ...
                    <div class="input-icon right col-sm-3 col-xs-5">
                        <i class="fa"></i><input type="text" id="serino" name="serino" value="{{ Input::old('serino') }}" data-required="1" class="form-control" maxlength="15" tabindex="1">
                    </div>
                ...
                <div class="form-group col-sm-6 col-xs-12">
                    <label class="control-label col-sm-4 col-xs-3">T1 Tüketim:i<span class="required" aria-required="true"> * </span></label>
                    <div class="input-icon right col-sm-8 col-xs-9">
                        <i class="fa"></i><input type="text" id="t1deger" name="t1deger" value="{{ Input::old('t1deger') }}" maxlength="14" data-required="1" class="form-control" tabindex="6">
                    </div>
                </div>
                <div class="form-group col-sm-6 col-xs-12">
                    <label class="control-label col-sm-4 col-xs-3">T2 Tüketimi:<span class="required" aria-required="true"> * </span></label>
                    <div class="input-icon right col-sm-8 col-xs-9">
                        <i class="fa"></i><input type="text" id="t2deger" name="t2deger" value="{{ Input::old('t2deger') }}" maxlength="14" data-required="1" class="form-control" tabindex="7">
                    </div>
                </div>
                <div class="form-group col-sm-6 col-xs-12">
                    <label class="control-label col-sm-4 col-xs-3">T3 Tüketimi:<span class="required" aria-required="true"> * </span></label>
                    <div class="input-icon right col-sm-8 col-xs-9">
                        <i class="fa"></i><input type="text" id="t3deger" name="t3deger" value="{{ Input::old('t3deger') }}" maxlength="14" data-required="1" class="form-control" tabindex="8">
                    </div>
                </div>
                <div class="form-group col-sm-6 col-xs-12">
                    <label class="control-label col-sm-4 col-xs-3">T4 Tüketimi:<span class="required" aria-required="true"> * </span></label>
                    <div class="input-icon right col-sm-8 col-xs-9">
                        <i class="fa"></i><input type="text" id="t4deger" name="t4deger" value="{{ Input::old('t4deger') }}" maxlength="14" data-required="1" class="form-control" tabindex="9">
                    </div>
                </div>
                <div class="form-group col-sm-6 col-xs-12">
                    <label class="control-label col-sm-4 col-xs-3">Toplam Tüketim:<span class="required" aria-required="true"> * </span></label>
                    <div class="input-icon right col-sm-8 col-xs-9">
                        <i class="fa"></i><input type="text" id="ttoplam" name="ttoplam" value="{{ Input::old('ttoplam') }}" maxlength="14" data-required="1" class="form-control" tabindex="10">
                    </div>
                </div>
                <div class="form-group col-sm-6 col-xs-12">
                    <label class="control-label col-sm-4 col-xs-3">Kalan Kredi:<span class="required" aria-required="true"> * </span></label>
                    <div class="input-icon right col-sm-8 col-xs-9">
                        <i class="fa"></i><input type="text" id="kalankredi" name="kalankredi" value="{{ Input::old('kalankredi') }}" maxlength="14" data-required="1" class="form-control" tabindex="11">
                    </div>
                </div>
                <div class="form-group col-xs-12">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8 col-xs-7">
                        <input type="text" id="arizanot" name="arizanot" value="{{ Input::old('arizanot') }}" data-required="1" class="form-control" tabindex="22">
                    </div>
                </div>
                            ...
                            <div class="portlet-body form">
                                <form action="" id="form_sample_2" class="form-horizontal" novalidate="novalidate">
                                    <div class="form-body">
                                        ...
                                        <div class="form-group col-sm-6 col-xs-12">
                                            <label class="control-label col-xs-4">T1 Tüketim</label>
                                            <label class="col-xs-8 eskit1" style="padding-top: 9px"></label>
                                        </div>
                                        <div class="form-group col-sm-6 col-xs-12">
                                            <label class="control-label col-xs-4">T2 Tüketim</label>
                                            <label class="col-xs-8 eskit2" style="padding-top: 9px"></label>
                                        </div>
                                        <div class="form-group col-sm-6 col-xs-12">
                                            <label class="control-label col-xs-4">T3 Tüketim</label>
                                            <label class="col-xs-8 eskit3" style="padding-top: 9px"></label>
                                        </div>
                                        <div class="form-group col-sm-6 col-xs-12">
                                            <label class="control-label col-xs-4">T4 Tüketim</label>
                                            <label class="col-xs-8 eskit4" style="padding-top: 9px"></label>
                                        </div>
                                        <div class="form-group col-sm-6 col-xs-12">
                                            <label class="control-label col-xs-4">Toplam Tüketim</label>
                                            <label class="col-xs-8 eskitt" style="padding-top: 9px"></label>
                                        </div>
                                        <div class="form-group col-sm-6 col-xs-12">
                                        ...
                                        <div class="form-group col-xs-12">
                                            <label class="control-label col-sm-2 col-xs-4">Kayıt Yapan:</label>
