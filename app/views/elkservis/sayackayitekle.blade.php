...
<div class="page-title">
    <h1>Elektrik Sayaç Kayıt <small>Ekleme Ekranı</small></h1>
</div>
@stop
...
@section('page-script')
<script src="{{ URL::to('pages/elkservis/form-validation-5.js') }}"></script>
@stop
                    ...
                    if (event.durum) {
                        ...
                        if(abonesayackayit.length>0){
                            ...
                            $('.detay').click(function(){
                                ...
                                if(kayitid!=="") {
                                    $.blockUI();
                                    $.getJSON("{{ URL::to('elkservis/abonekayitdetay') }}",{kayitid:kayitid}, function (event) {
                                        if(event.durum){
                                            var abonesayackayit = event.abonesayackayit;
...
<div class="portlet box">
    ...
    <div class="portlet-body form">
        <!-- BEGIN FORM-->
        <form action="{{ URL::to('elkservis/sayackayitekle') }}" id="form_sample" method="POST" class="form-horizontal" novalidate="novalidate">
            <div class="form-body">
            ...
            <div class="form-actions">
                <div class="row">
                    <div class="col-xs-12" style="text-align: center">
                        ...
                        <a href="{{ URL::to('elkservis/sayackayit')}}" class="btn default">Vazgeç</a>
                    </div>
                </div>
            </div>
        </form>
