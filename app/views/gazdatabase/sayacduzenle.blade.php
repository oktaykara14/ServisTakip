...
<div class="page-title">
    <h1>Gaz Sayaç <small>Bilgi Düzenleme Ekranı</small></h1>
</div>
@stop
...
@section('page-script')
<script src="{{ URL::to('pages/gazdatabase/form-validation-14.js') }}"></script>
@stop
...
<div class="portlet box">
    ...
    <div class="portlet-body form">
        <!-- BEGIN FORM-->
        <form action="{{ URL::to('gazdatabase/sayacduzenle/'.$sayac->id.'') }}" id="form_sample" method="POST" class="form-horizontal" novalidate="novalidate">
            <div class="form-body">
