...
@section('page-script')
<script src="{{ URL::to('pages/gazdatabase/form-validation-9.js') }}"></script>
@stop
...
$(document).ready(function() {
    $('#sayacadi').on('change', function () {
        ...
        if (adiid !== "") {
            $.blockUI();
            $.getJSON("{{ URL::to('gazdatabase/sayacparcalari') }}",{adiid:adiid,capid:1}, function (event) {
                if (event.durum) {
    ...
    if (sayacadi !== "") {
        $.blockUI();
        $.getJSON("{{ URL::to('gazdatabase/sayacparcalari') }}",{adiid:sayacadi,capid:1}, function (event) {
            if (event.durum) {
                var sayacparca = event.parcalar;
...
<div class="portlet box">
    ...
    <div class="portlet-body form">
        <!-- BEGIN FORM-->
        <form action="{{ URL::to('gazdatabase/garantiduzenle/'.$sayacgaranti->id.'') }}" id="form_sample" method="POST" class="form-horizontal" novalidate="novalidate">
            <div class="form-body">
            ...
            <div class="row">
                <div class="col-xs-12" style="text-align: center">
                    ...
                    <a href="{{ URL::to('gazdatabase/sayacgaranti')}}" class="btn default">Vazgeç</a>
                </div>
            </div>
            </div>
        </form>
