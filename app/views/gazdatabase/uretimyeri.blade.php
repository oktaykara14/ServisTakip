...
@section('page-title')
    <div class="page-title">
        <h1>Servis <small>Üretim Yerleri Bilgi Ekranı</small></h1>
    </div>
@stop
...
@section('scripts')
    ...
    <script>
        ...
        var oTable = table.DataTable({
            ...
            "bProcessing": true,
            "ajax": {
                "url": "{{ URL::to('gazdatabase/uretimyerilist') }}",
                "type": "POST",
                "data": {
                }
            },
            ...
            "columns": [
                {data: 'id', name: 'uretimyer.id',"class":"id","orderable": true, "searchable": true},
                {data: 'yeradi', name: 'uretimyer.yeradi',"orderable": true, "searchable": false},
                {data: 'issue', name: 'uretimyer.issue',"orderable": true, "searchable": true},
                {data: 'gbirimi', name: 'parabirimi.gbirimi',"orderable": true, "searchable": false},
        ...
        $('<label>Kriter: </label><select style="height: 34px;margin-left: 5px;border-radius: 4px;padding-top:2px;padding-right: 10px" id="kriter" tabindex="-1" title="" class="select2me">'+
            ...
            '<option value="5">Para Birimi</option>'+
    ...
    <script>
        $(document).on("click", ".delete", function () {
            var id = $(this).data('id');
            $(".modal-footer #sayacid").attr('href',"{{ URL::to('gazdatabase/uretimyerisil') }}/"+id);
        });
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-tag"></i>Üretim Yerleri
                    </div>
                    <div class="actions">
                        <a href="{{ URL::to('gazdatabase/uretimyeriekle') }}" class="btn btn-default btn-sm">
                            <i class="fa fa-pencil"></i> Yeni Üretim Yeri Ekle </a>
                    </div>
                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Üretim Yeri Silinecek</h4>
                </div>
                <div class="modal-body">
                    Seçilen Üretim Yerini Silmek İstediğinizden Emin Misiniz?
                </div>
