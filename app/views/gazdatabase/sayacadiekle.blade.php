...
<div class="page-title">
    <h1>Gaz Sayaç Adı <small>Ekleme Ekranı</small></h1>
</div>
@stop
...
@section('page-script')
<script src="{{ URL::to('pages/gazdatabase/form-validation-2.js') }}"></script>
@stop
...
<div class="portlet box">
    ...
    <div class="portlet-body form">
        <!-- BEGIN FORM-->
        <form action="{{ URL::to('gazdatabase/sayacadiekle') }}" id="form_sample" method="POST" class="form-horizontal" novalidate="novalidate">
            <div class="form-body">
            ...
            <div class="row">
                <div class="col-xs-12" style="text-align: center">
                    ...
                    <a href="{{ URL::to('gazdatabase/sayacadi')}}" class="btn default">Vazgeç</a>
                </div>
            </div>
            </div>
        </form>
