...
@section('page-title')
    <div class="page-title">
        <h1>Gaz Stok Hareketi <small>Düzenleme Ekranı</small></h1>
    </div>
@stop
...
@section('content')
    <div class="portlet box">
        ...
        <div class="portlet-body form">
            <!-- BEGIN FORM-->
            <form action="{{ URL::to('gazdatabase/stokhareketduzenle/'.$stokgiriscikis->id.'') }}" id="form_sample" method="POST" class="form-horizontal" novalidate="novalidate">
                <div class="form-body">
