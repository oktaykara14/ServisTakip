...
@section('page-title')
    <div class="page-title">
        <h1>Gaz Servis <small>Sayaç Yapılan İşlemler Bilgi Ekranı</small></h1>
    </div>
@stop
...
@section('scripts')
    ...
    <script>
        ...
        var oTable = table.DataTable({
            ...
            "bProcessing": true,
            "ajax": {
                "url": "{{ URL::to('gazdatabase/yapilanlarlist') }}",
                "type": "POST",
                "data": {
                }
            },
    ...
    <script>
        $(document).on("click", ".delete", function () {
            var id = $(this).data('id');
            $(".modal-footer #sayacid").attr('href',"{{ URL::to('gazdatabase/yapilansil') }}/"+id);
        });
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box">
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        <a href="{{ URL::to('gazdatabase/yapilanekle') }}" class="btn btn-default btn-sm">
