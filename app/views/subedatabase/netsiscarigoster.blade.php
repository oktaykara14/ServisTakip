    ...
    <div class="portlet-body form">
        ...
        <form action="" id="form_sample" class="form-horizontal" novalidate="novalidate">
            <div class="form-body">
                ...
                <div class="form-group">
                    <label class="control-label col-xs-2">Adresi:</label>
                    <label class="col-xs-4 adres" style="padding-top: 9px">{{$netsiscari->adres}}</label>
                    <label class="control-label col-xs-2">Tc Kimlik No:</label>
                    <label class="col-xs-4 tckimlikno" style="padding-top: 9px">{{$netsiscari->tckimlikno}}</label>
                </div>
                <div class="form-group">
            ...
            <div class="row">
                <div class="col-xs-12" style="text-align: center">
                    <a href="{{ URL::to('subedatabase/netsiscari')}}" class="btn green">Tamam</a>
                </div>
            </div>
            </div>
        </form>
