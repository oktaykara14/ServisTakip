...
@section('page-title')
    <div class="page-title">
        <h1>Personel<small> Bilgi Ekranı</small></h1>
    </div>
@stop
...
@section('scripts')
    ...
    <script>
        ...
        var oTable = table.DataTable({
            ...
            "bProcessing": true,
            "ajax": {
                "url": "{{ URL::to('subedatabase/personellist') }}",
                "type": "POST",
                "data": {
            ...
            "fnDrawCallback" : function() {
                $(document).on("click", ".delete", function () {
                    var id = $(this).data('id');
                    $(".modal-footer #sayacid").attr('href',"{{ URL::to('subedatabase/personelsil') }}/"+id );
                });
            },
            "language": {
            ...
            "columns": [
                {data: 'id', name: 'subepersonel.id',"class":"id","orderable": true, "searchable": true},
        ...
        $('<label>Kriter: </label><select style="height: 34px;margin-left: 5px;border-radius: 4px;padding-top:2px;padding-right: 10px" id="kriter" tabindex="-1" title="" class="select2me">'+
            ...
            '<option value="3">Adı Soyadı</option>'+
            '<option value="4">Şubesi</option>'+
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-tag"></i>Şube Personel Bilgileri
                    </div>
                    <div class="actions">
                        <a href="{{ URL::to('subedatabase/personelekle') }}" class="btn btn-default btn-sm">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Personel Bilgisi Silinecek</h4>
                </div>
                <div class="modal-body">
                    Seçilen Personel Bilgisini Silmek İstediğinizden Emin Misiniz?
                </div>
