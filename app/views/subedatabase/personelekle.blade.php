...
<div class="page-title">
    <h1>Şube Personel <small>Ekleme Ekranı</small></h1>
</div>
@stop
...
<div class="portlet box">
    ...
    <div class="portlet-body form">
        <!-- BEGIN FORM-->
        <form action="{{ URL::to('subedatabase/personelekle') }}" id="form_sample" method="POST" class="form-horizontal" novalidate="novalidate">
            <div class="form-body">
                    ...
                    <div class="input-icon right col-xs-6">
                        <i class="fa"></i><select class="form-control select2me select2-offscreen" id="sube" name="sube" tabindex="-1" title="">
                            ...
                            @foreach($subeler as $sube)
                                @if(Input::old('sube')==$sube->subekodu)
