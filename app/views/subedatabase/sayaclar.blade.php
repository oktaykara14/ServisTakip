...
<div class="page-title">
    <h1>Şube <small>Sayaç Listesi</small></h1>
</div>
@stop
...
@section('scripts')
    ...
    <script>
        ...
        var oTable = table.DataTable({
            ...
            "bProcessing": true,
            "ajax": {
                "url": "{{ URL::to('subedatabase/sayaclist') }}",
                "type": "POST",
                "data": {
    ...
    $(document).on("click", ".delete", function() {
         var id = $(this).data('id');
         $(".modal-footer #sayacid").attr('href',"{{ URL::to('subedatabase/sayacsil') }}/"+id);
    });
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box">
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        <a href="{{ URL::to('subedatabase/tektekekle') }}" class="btn btn-default btn-sm">
                            <i class="fa fa-pencil"></i> Tek Tek Sayaç Ekle </a>
                        <a href="{{ URL::to('subedatabase/siraliekle') }}" class="btn btn-default btn-sm">
