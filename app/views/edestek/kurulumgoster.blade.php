...
<div class="page-title">
    <h1>Kurulum Bilgisi <small></small></h1>
</div>
@stop
...
<div class="portlet box">
    <div class="portlet-title">
        <div class="caption">
            <i class="fa fa-eye"></i>Kurulum Bilgisi
        </div>
    </div>
    <div class="portlet-body form">
        ...
        <form action="" id="form_sample" class="form-horizontal" novalidate="novalidate">
            <div class="form-body">
                ...
                <div class="form-group">
                    <label class="control-label col-md-2 col-xs-12">Kurulum</label>
                    <label class="col-md-5 col-xs-12" style="padding-top: 7px">{{ $kurulum->edestekkurulumtur->adi }}</label>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <label class="col-md-4 col-xs-12" style="padding-top: 7px">@if($kurulum->durum=='0'){{ 'Bekliyor' }} @elseif($kurulum->durum=='1'){{ 'Tamamlandı' }} @endif </label>
