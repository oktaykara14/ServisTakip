...
<div class="page-title">
    <h1>Düzenli İşlem Bilgisi <small>Ekleme Ekranı</small></h1>
</div>
@stop
...
<div class="portlet box">
    <div class="portlet-title">
        <div class="caption">
            <i class="fa fa-plus"></i>Düzenli İşlem Bilgisi Ekle
        </div>
    </div>
    <div class="portlet-body form">
        <!-- BEGIN FORM-->
        <form action="{{ URL::to('edestek/islemekle') }}" id="form_sample" method="POST" class="form-horizontal" novalidate="novalidate">
            <div class="form-body">
                ...
                <div class="form-group">
                    ...
                    <div class="input-icon right col-md-8">
                        <i class="fa"></i><div class="input-group input-large date date-picker" style="padding-left: 12px !important;" data-date-format="dd-mm-yyyy" data-date-viewmode="years">
                            <input id="baslangictarih" type="text" name="baslangictarih" class="form-control" value="{{Input::old('baslangictarih') }}">
                ...
                <div class="form-group">
                    ...
                    <div class="input-icon right col-md-1 col-xs-6">
                        <i class="fa"></i><input type="text" name="aralik" id="mask_number" value="{{Input::old('aralik')}}" data-required="1" class="form-control">
                    </div>
                    <div class="col-md-5 col-xs-6">
                        <select class="form-control select2me select2-offscreen" id="options2" name="options2" tabindex="-1" title="">
                            <option value="">Seçiniz...</option>
                            <option value="1" @if(Input::old('options2')=='1') selected @endif >Gün</option>
                            <option value="2" @if(Input::old('options2')=='2') selected @endif>Hafta</option>
                            <option value="3" @if(Input::old('options2')=='3') selected @endif>Ay</option>
                            <option value="4" @if(Input::old('options2')=='4') selected @endif>Yıl</option>
                        </select>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="input-icon right col-md-6 col-xs-12">
                        <i class="fa"></i><select class="form-control select2me select2-offscreen" id="options4" name="options4" tabindex="-1" title="">
                            ...
                            @foreach($islemler as $islem)
                                @if(Input::old('options4')==$islem->id )
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-7 col-xs-12">
                        <textarea2 id="islemdetayyeni" name="islemdetayyeni">{{Input::old('islemdetayyeni') }}</textarea2>
                    </div>
                </div>
                <input id="islemdetayyeniid" name="islemdetayyeniid" class="hide" value="{{Input::old('islemdetayyeni') }}" />
                <div class="form-group">
                    ...
                    <div class="input-icon right col-md-7 col-xs-12">
                        <i class="fa"></i><select class="form-control select2me select2-offscreen" id="options5" name="options5" tabindex="-1" title="">
                            ...
                            @foreach($personeller as $personel)
                                @if(Input::old('options5')==$personel->id )
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-7 col-xs-12">
                        <select class="form-control select2me select2-offscreen" id="options6" name="options6" tabindex="-1" title="">
                            <option value="0" @if(Input::old('options6')=='0') selected @endif >Pasif</option>
                            <option value="1" @if(Input::old('options6')=='1') selected @endif >Aktif</option>
                        </select>
                    </div>
                </div>
