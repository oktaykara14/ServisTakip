...
<div class="page-title">
    <h1>Tamir Bakım Bilgisi <small>Ekleme Ekranı</small></h1>
</div>
@stop
...
<div class="portlet box">
    <div class="portlet-title">
        <div class="caption">
            <i class="fa fa-plus"></i>Tamir Bakım Bilgisi Ekle
        </div>
    </div>
    <div class="portlet-body form">
        <!-- BEGIN FORM-->
        <form action="{{ URL::to('edestek/tamirekle') }}" id="form_sample" method="POST" enctype="multipart/form-data" class="form-horizontal" novalidate="novalidate">
            <div class="form-body">
                    ...
                    <div class="input-icon right col-md-5 col-xs-12">
                        <i class="fa"></i><select class="form-control select2me select2-offscreen" id="options2" name="options2" tabindex="-1" title="">
                            ...
                            @foreach($tamirurunler as $tamirurun)
                                @if(Input::old('options2')==$tamirurun->id )
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-7">
                            <input type="text" name="urunadi" value="{{Input::old('urunadi')}}" data-required="1" class="form-control">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <div class="input-group input-large date date-picker" style="padding-left: 12px !important;" data-date-format="dd-mm-yyyy" data-date-viewmode="years">
                                <input id="gelistarih" type="text" name="gelistarih" class="form-control" value="{{Input::old('gelistarih') }}">
                    ...
                    <div class="input-icon right col-md-5 col-xs-12">
                        <i class="fa"></i><select class="form-control select2me select2-offscreen" id="options3" name="options3" tabindex="-1" title="">
                            ...
                            @foreach($tamirislemler as $tamirislem)
                                @if(Input::old('options3')==$tamirislem->id )
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-7 col-xs-12">
                        <textarea2 id="tamirdetayyeni" name="tamirdetayyeni">{{Input::old('tamirdetayyeniid') }}</textarea2>
                    </div>
                </div>
                <input id="tamirdetayyeniid" name="tamirdetayyeniid" class="hide" value="{{Input::old('tamirdetayyeniid') }}" />
                <div class="form-group">
                    <label class="control-label col-md-2">Sevk Tarihi</label>
                    <div class="col-md-8">
                        <div class="input-group input-large date date-picker" style="padding-left: 12px !important;" data-date-format="dd-mm-yyyy" data-date-viewmode="years">
                                <input id="sevktarih" type="text" name="sevktarih" class="form-control" value="{{Input::old('sevktarih') }}">
                                <span class="input-group-btn">
                                <button class="btn default" type="button" style="border:1px solid #969696;padding-bottom: 5px;"><i class="fa fa-calendar"></i></button>
                                </span>
                        </div>
