...
<div class="page-title">
    <h1>Kurulum Bilgisi <small>Düzenleme Ekranı</small></h1>
</div>
@stop
...
<div class="portlet box">
    <div class="portlet-title">
        <div class="caption">
            <i class="fa fa-pencil"></i>Kurulum Bilgisi Düzenle
        </div>
    </div>
    <div class="portlet-body form">
        <!-- BEGIN FORM-->
        <form action="{{ URL::to('edestek/kurulumduzenle/'.$kayit->id.'') }}" id="form_sample" method="POST" enctype="multipart/form-data" class="form-horizontal" novalidate="novalidate">
            <div class="form-body">
                    ...
                    <div class="input-icon right col-md-7 col-xs-12">
                        <i class="fa"></i><select class="form-control select2me select2-offscreen" id="options2" name="options2" tabindex="-1" title="">
                            ...
                            @foreach($personeller as $personel)
                                @if((Input::old('options2')? Input::old('options2') : $kayit->edestekpersonel_id)==$personel->id )
                    ...
                    <div class="input-icon right col-md-5 col-xs-12">
                        <i class="fa"></i><select class="form-control select2me select2-offscreen" id="options3" name="options3" tabindex="-1" title="">
                            ...
                            @foreach($kurulumturleri as $kurulumtur)
                                @if((Input::old('options3')? Input::old('options2') : $kurulum->edestekkurulumtur_id)==$kurulumtur->id )
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-7 col-xs-12">
                        <textarea2 id="kurulumdetayyeni" name="kurulumdetayyeni">{{Input::old('kurulumdetayid') ? Input::old('kurulumdetayid') : $kurulum->detay }}</textarea2>
                    </div>
                </div>
                <input id="kurulumdetayyeniid" name="kurulumdetayyeniid" class="hide" value="{{Input::old('kurulumdetayid') ? Input::old('kurulumdetayid') : $kurulum->detay }}"/>
                <div class="form-group">
                    ...
                    <div class="col-md-3" style="padding-top: 7px">
                        <a href='{{ URL::to('assets/tutanak/'.$kurulum->tutanak.'') }}' style="color: red">{{ $kurulum->tutanak }}</a>
                    </div>
                    @endif
                </div>
                <div class="form-group">
