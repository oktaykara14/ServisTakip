...
<div class="page-title">
    <h1>Proje Bilgisi <small>Ekleme Ekranı</small></h1>
</div>
@stop
...
<div class="portlet box ">
    <div class="portlet-title">
        <div class="caption">
                <i class="fa fa-plus"></i>Proje Bilgisi Ekle
        </div>
    </div>
    <div class="portlet-body form" style="display: block;">
        <div class="form-body">
            <div class="tabbable-line">
                ...
                <form action="{{ URL::to('edestek/musteriekle') }}" id="form_sample" method="POST" enctype="multipart/form-data"  class="form-horizontal" novalidate="novalidate">
                    <div class="tab-content">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-icon right col-md-8">
                                        <i class="fa"></i><input type="text" name="adi" value="{{Input::old('adi')}}" data-required="1" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-2">
                                        <div class="input-group input-medium date date-picker" style="padding-left: 12px !important;" data-date-format="dd-mm-yyyy" data-date-viewmode="years">
                                                <input id="baslangic" type="text" name="baslangic" class="form-control" value="{{Input::old('baslangic') }}">
                                    ...
                                    <div class="col-md-3">
                                        <div class="input-group input-medium date date-picker" style="padding-left: 12px !important;" data-date-format="dd-mm-yyyy" data-date-viewmode="years">
                                                <input id="bitis" type="text" name="bitis" class="form-control" value="{{Input::old('bitis') }}">
                                                <span class="input-group-btn">
                                                <button class="btn default" type="button" style="border:1px solid #969696;padding-bottom: 5px;"><i class="fa fa-calendar"></i></button>
                                                </span>
                                        </div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-offset-1 col-md-10 col-xs-12">
                                        <textarea2 id="projedetayyeni" name="projedetayyeni">{{Input::old('projedetayyeniid') }}</textarea2>
                                    </div>
                                </div>
                                <input id="projedetayyeniid" name="projedetayyeniid" class="hide" value="{{Input::old('projedetayyeniid') }}"/>
                        ...
                        <div class="tab-pane" id="tab_2">
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                            <input type="text" name="adresi" value="{{Input::old('adresi')}}"  class="form-control">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <input class="form-control" id="mask_phone" name="telefon" value="{{Input::old('telefon')}}"  type="text">
                                    </div>
                                    <label class="control-label col-md-2">Maili </label>
                                    <div class="col-md-3">
                                            <input type="text" name="mail" value="{{Input::old('mail')}}"  class="form-control">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-md-2">Yetkili Kişi </label>
                                    <div class="col-md-3">
                                            <input type="text" name="yetkili" value="{{Input::old('yetkili')}}"  class="form-control">
                                    </div>
                                    <label class="control-label col-md-2">Yetkili Telefonu </label>
                                    <div class="col-md-3">
                                            <input type="text" id="mask_phone2" name="yetkilitel" value="{{Input::old('yetkilitel')}}"  class="form-control">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane" id="tab_3">            
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">
                                        <img src="{{ URL::to('assets/images/Teamviewer.png')}}" style="width:30px;height: 30px;margin-right: 5px"/>
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                                <input type="text" name="teamid" value="{{Input::old('teamid')}}"  class="form-control">
                                        </div>
                                        <label class="control-label col-md-2">Parola </label>
                                        <div class="col-md-3">
                                                <input type="text" name="teampass" value="{{Input::old('teampass')}}"  class="form-control">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">
                                        <img src="{{ URL::to('assets/images/Ammyy.png')}}" style="width:30px;height: 30px;margin-right: 5px"/>
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        <label class="control-label col-md-2">Id </label>
                                        <div class="col-md-8">
                                                <input type="text" name="ammyyid" value="{{Input::old('ammyyid')}}"  class="form-control">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">
                                        <img src="{{ URL::to('assets/images/Alpemix.png')}}" style="width:30px;height: 30px;margin-right: 5px"/>
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        <label class="control-label col-md-2">Id </label>
                                        <div class="col-md-3">
                                                <input type="text" name="alpemixid" value="{{Input::old('alpemixid')}}"  class="form-control">
                                        </div>
                                        <label class="control-label col-md-2">Parola </label>
                                        <div class="col-md-3">
                                                <input type="text" name="alpemixpass" value="{{Input::old('alpemixpass')}}"  class="form-control">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">
                                        <img src="{{ URL::to('assets/images/UzakBaglanti.png')}}" style="width:30px;height: 30px;margin-right: 5px"/>
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                                <input type="text" name="uzakip" value="{{Input::old('uzakip')}}"  class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-2">Kullanıcı Adı </label>
                                        <div class="col-md-3">
                                                <input type="text" name="uzakkullanici" value="{{Input::old('uzakkullanici')}}"  class="form-control">
                                        </div>
                                        <label class="control-label col-md-2">Parola </label>
                                        <div class="col-md-3">
                                                <input type="text" name="uzakpass" value="{{Input::old('uzakpass')}}"  class="form-control">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane" id="tab_5">
                            <div class="form-body">
                                ...
                                <div class="panel susayac panel-default hide">
                                    <div class="panel-heading">
                                        <h3 class="panel-title ">
                                            <img src="{{ URL::to('assets/images/susayac.png')}}" style="width:30px;height: 30px;margin-right: 5px"/>
                                ...
                                <div class="panel elksayac panel-default hide">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">
                                            <img src="{{ URL::to('assets/images/elektriksayac.png')}}" style="width:30px;height: 30px;margin-right: 5px"/>
                        ...
                        <div class="tab-pane" id="tab_6">
                            <div class="form-body">
                                ...
                                <div class="panel forcom panel-default hide">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">
