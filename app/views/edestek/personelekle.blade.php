...
<div class="page-title">
    <h1>Personel <small>Ekleme Ekranı</small></h1>
</div>
@stop
    ...
    $('#options1').on('change', function () {
        ...
        if (id !== "") {
            $.getJSON(" {{ URL::to('edestek/kullanici') }}/" + id, function (event) {
                if (event.kullanici.email === null) {
                    $('#email').val("");
                } else {
                    $('#email').val(event.kullanici.email);
                }
            });
        } else {
            $('#email').val("");
...
<div class="portlet box green">
    <div class="portlet-title">
        <div class="caption">
            <i class="fa fa-user-plus"></i>Personel Ekle
        </div>
    </div>
    <div class="portlet-body form">
        <!-- BEGIN FORM-->
        <form action="{{ URL::to('edestek/personelekle') }}" id="form_sample" method="POST" class="form-horizontal" novalidate="novalidate">
            <div class="form-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-7">
                        <div class="input-group input-medium date date-picker" style="padding-left: 12px !important;" data-date-format="dd-mm-yyyy" data-date-viewmode="years">
                                <input id="giristarihi" type="text" name="giristarihi" class="form-control" value="{{Input::old('giristarihi') }}">
                    ...
                    <div class="input-icon right col-md-7">
                        <i class="fa"></i><select class="form-control select2me select2-offscreen" id="options1" name="options1" tabindex="-1" title="">
                            ...
                            @foreach($kullanicilar as $kullanici)
                                @if(Input::old('options1')==$kullanici->id )
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-7">
                        <div class="input-group">
                            ...
                            <input type="email" id="email" name="email" value="{{ Input::old('email') ? Input::old('email') : '' }}" class="form-control" readonly placeholder="Email Adresi">
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-7">
                        <input type="text" name="meslek" value="{{Input::old('meslek') }}" class="form-control">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                        ...
                        <div class="col-md-9">
                                <div class="bootstrap-switch bootstrap-switch-wrapper bootstrap-switch-off bootstrap-switch-animate" style="width: 116px;">
                                    ...
                                    <input type="checkbox" id="durum" name="durum" class="make-switch" data-on-color="success" data-off-color="warning" data-on-text="Aktif" data-off-text="Pasif" @if(Input::old('durum')) checked @endif></div>
                                </div>
                        </div>
                </div>
