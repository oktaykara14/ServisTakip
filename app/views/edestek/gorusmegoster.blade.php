...
<div class="page-title">
    <h1>Görüşme Bilgisi <small></small></h1>
</div>
@stop
...
<div class="portlet box">
    <div class="portlet-title">
        <div class="caption">
            <i class="fa fa-eye"></i>Telefon Görüşme Bilgisi
        </div>
    </div>
        ...
        <form action="" id="form_sample" class="form-horizontal" novalidate="novalidate">
            <div class="form-body">
                ...
                <div class="form-group">
                    ...
                    <label class="col-md-5 col-xs-12" style="padding-top: 7px">{{ $gorusme->yetkiliadi }}</label>

                </div>
                <div class="form-group">
                    <label class="control-label col-md-2">Yetkili Telefonu</label>
                    <label class="col-md-5 col-xs-12" style="padding-top: 7px">{{ $gorusme->yetkilitel }}</label>

                </div>
                <div class="form-group">
                    <label class="control-label col-md-2">Tarih</label>
                    <label class="col-md-5 col-xs-12" style="padding-top: 7px">{{ date("d-m-Y", strtotime($kayit->tarih)) }}</label>

                </div>
                <div class="form-group">
                    <label class="control-label col-md-2 col-xs-12">Konu</label>
                    <label class="col-md-5 col-xs-12" style="padding-top: 7px">{{ $gorusme->edestekkonu->adi }}</label>

                </div>
                <div class="form-group">
                    <label class="control-label col-md-2 col-xs-12">Detay</label>
                    <label class="col-md-5 col-xs-12" style="padding-top: 7px">{{ $gorusme->edestekkonudetay->detay }}</label>

                </div>
                <div class="form-group">
                    <label class="control-label col-md-2">Problem </label>
                    <label class="col-md-5 col-xs-12" style="padding-top: 7px">{{ $gorusme->problem }}</label>

                </div>
                <div class="form-group">
                    <label class="control-label col-md-2 col-xs-12">Yapılan İşlem</label>
                    <div class="col-md-7 col-xs-12">
                        <textarea2 id="gorusmedetay" name="gorusmedetay">{{  $gorusme->cozum }}</textarea2>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <label class="col-md-4 col-xs-12" style="padding-top: 7px">@if($gorusme->durum=='0'){{ 'Bekliyor' }} @elseif($gorusme->durum=='1'){{ 'Tamamlandı' }} @elseif($gorusme->durum=='2'){{ 'Devredildi' }} @elseif($gorusme->durum=='3'){{ 'İptal Edildi' }} @endif </label>
