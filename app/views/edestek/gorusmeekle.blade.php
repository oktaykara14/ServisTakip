...
@section('page-title')
    <div class="page-title">
        <h1>Telefon Görüşmesi Bilgi <small>Ekleme Ekranı</small></h1>
    </div>
@stop
    ...
    <div class="col-md-8">
        <div class="portlet box">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-plus"></i>Telefon Görüşmesi Bilgi Ekle
                </div>
            </div>
            <div class="portlet-body form">
                <!-- BEGIN FORM-->
                <form action="{{ URL::to('edestek/gorusmeekle') }}" id="form_sample" method="POST" class="form-horizontal" novalidate="novalidate">
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" id="yetkiliadi" name="yetkiliadi" value="{{Input::old('yetkiliadi')}}" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-2">Yetkili Telefonu</label>
                            <div class="col-md-9">
                                <input type="text" id="mask_phone" name="telefon" value="{{Input::old('telefon')}}" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-icon right col-md-6 col-xs-12">
                                <i class="fa"></i><select class="form-control select2me select2-offscreen" id="options3" name="options3" tabindex="-1" title="">
                                    ...
                                    @foreach($detaylar as $detay)
                                        @if(Input::old('options3')==$detay->id )
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-icon right col-md-9">
                                <i class="fa"></i><input type="text" id="problem" name="problem" value="{{Input::old('problem')}}" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-2 col-xs-12">Yapılan İşlem </label>
                            <div class="col-md-9 col-xs-12">
                                <textarea2 id="gorusmedetayyeni" name="gorusmedetayyeni">{{Input::old('gorusmedetayyeniid') }}</textarea2>
                            </div>
                        </div>
                        <input id="gorusmedetayyeniid" name="gorusmedetayyeniid" class="hide" value="{{Input::old('gorusmedetayyeniid') }}" />
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4 col-xs-12">
                                <select class="form-control select2me select2-offscreen" id="options5" name="options5" tabindex="-1" title="">
                                    ...
                                    <option value="2" @if(Input::old('options5')=='2') selected @endif >Devredildi</option>
                                    <option value="3" @if(Input::old('options5')=='3') selected @endif >İptal Edildi</option>
                                </select>
                            </div>
                        ...
                        <div class="portlet box">
                            ...
                            <div class="portlet-body form">
                                <form action="" id="form_sample_2" class="form-horizontal" novalidate="novalidate">
                                    <div class="form-body">
                                        <h3 class="form-section">Müşteri Düzenle</h3>
                                        <div class="alert alert-danger display-hide">
                                            <button class="close" data-close="alert"></button>
                                            Girilen Bilgilerde Hata Var.
                                        </div>
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-icon right col-md-7 col-xs-12">
                                                <i class="fa"></i><select class="form-control select2me select2-offscreen" id="options8" name="options8" tabindex="-1" title="">
                                                    <option value="">Seçiniz...</option>
                                                </select>
                                            </div>
                                        </div>
