...
<div class="page-title">
    <h1>İşlem Bilgisi <small></small></h1>
</div>
@stop
...
<div class="portlet box">
    <div class="portlet-title">
        <div class="caption">
            <i class="fa fa-eye"></i>İşlem Bilgisi
        </div>
    </div>
        ...
        <form action="" id="form_sample" class="form-horizontal" novalidate="novalidate">
            <div class="form-body">
                ...
                <div class="form-group">
                    ...
                    <label class="col-md-5 col-xs-12" style="padding-top: 7px">{{ $islem->edestekkonu->adi }}</label>

                </div>
                <div class="form-group">
                    <label class="control-label col-md-2 col-xs-12">İşlem</label>
                    <label class="col-md-5 col-xs-12" style="padding-top: 7px">{{ $islem->edestekkonuislem->islem }}</label>

                </div>
                <div class="form-group">
                    <label class="control-label col-md-2 col-xs-12">Detayı</label>
                    <div class="col-md-7 col-xs-12">
                        <textarea2 id="islemdetay" name="islemdetay">{{  $islem->detay }}</textarea2>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <label class="col-md-4 col-xs-12" style="padding-top: 7px">@if($islem->durum=='0'){{ 'Bekliyor' }} @elseif($islem->durum=='1'){{ 'Tamamlandı' }} @endif </label>
