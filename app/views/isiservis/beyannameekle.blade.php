...
@section('page-script')
<script src="{{ URL::to('pages/isiservis/form-validation-6.js') }}"></script>
@stop
...
jQuery(document).ready(function() {
    ...
    var oTable = table.DataTable({
        ...
        "bProcessing": true,
        "ajax": {
            "url": "{{ URL::to('isiservis/beyannamekayitlist') }}",
            "type": "POST",
            "data": {
            }
        },
...
<div class="portlet box">
    ...
    <div class="portlet-body form">
        <!-- BEGIN FORM-->
        <form action="{{ URL::to('isiservis/beyannameekle') }}" id="form_sample" method="POST" class="form-horizontal" novalidate="novalidate" enctype="multipart/form-data">
            <div class="form-body">
            ...
            <div class="form-actions">
                <div class="row">
                    <div class="col-xs-12" style="text-align: center">
                        ...
                        <a href="{{ URL::to('isiservis/beyanname')}}" class="btn default">Vazgeç</a>
                    </div>
                </div>
            </div>
        </form>
