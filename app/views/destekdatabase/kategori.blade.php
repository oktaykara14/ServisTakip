...
<div class="page-title">
    <h1>Yazılım Destek <small>Kategori Bilgi Ekranı</small></h1>
</div>
@stop
...
<script>
    ...
    var oTable = table.DataTable({
        ...
        "bProcessing": false,
        "ajax": {
            "url": "{{ URL::to('destekdatabase/kategorilist') }}",
            "type": "POST",
            "data": {
            }
        },
        ...
        "columns": [
            ...
            {data: 'kategori_adi', name: 'kategori.kategori_adi',"orderable": true, "searchable": true},
            {data: 'ust_kategori', name: 'ust_kategori',"orderable": true, "searchable": true},
    ...
    $('<label>Kriter: </label><select style="height: 34px;margin-left: 5px;border-radius: 4px;padding-top:2px;padding-right: 10px" id="kriter" tabindex="-1" title="" class="select2me">'+
        ...
        '<option value="2">Üst Kategorileri</option>'+
...
$(document).on("click", ".delete", function () {
     var id = $(this).data('id');
     $(".modal-footer #kategoriid").attr('href',"{{ URL::to('destekdatabase/kategorisil') }}/"+id );
});
    ...
    <div class="col-md-12">
        ...
        <div class="portlet box">
            <div class="portlet-title">
                ...
                <div class="actions">
                    <a href="{{ URL::to('destekdatabase/kategoriekle') }}" class="btn btn-default btn-sm">
                        <i class="fa fa-pencil"></i> Kategori Ekle </a>
                </div>
            </div>
    ...
    <div class="modal-dialog">
            <div class="modal-content">
                    ...
                    <div class="modal-footer">
                            <a id="kategoriid" href="" type="button" class="btn blue">Sil</a>
