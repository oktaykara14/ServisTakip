...
<div class="page-title">
    <h1>Kategori <small>Ekleme Ekranı</small></h1>
</div>
@stop
...
<div class="portlet box">
    ...
    <div class="portlet-body form">
        <!-- BEGIN FORM-->
        <form action="{{ URL::to('destekdatabase/kategoriekle') }}" id="form_sample" method="POST" class="form-horizontal" novalidate="novalidate">
            <div class="form-body">
                ...
                <div class="form-group">
                    ...
                    <div class="input-icon right col-xs-6">
                        <i class="fa"></i><input type="text" id="kategori_adi" name="kategori_adi" value="{{Input::old('kategori_adi') }}" data-required="1" class="form-control">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-xs-6">
                        <select class="form-control select2me select2-offscreen" id="ust_kategori" name="ust_kategori" tabindex="-1" title="">
                            ...
                            @foreach($kategoriler as $kategori)
                                @if(Input::old('ust_kategori')==$kategori->id )
