...
<div class="page-title">
    <h1>Su Servis <small>Arıza Kayıt Ekranı</small></h1>
</div>
@stop
...
@section('scripts')
    ...
    <script>
        ...
        var oTable = table.DataTable({
            ...
            "bProcessing": true,
            "ajax": {
                "url": "{{ URL::to('suservis/arizakayitlist') }}",
                "type": "POST",
                "data": {
            ...
            "fnDrawCallback" : function() {
                $(document).on("click", ".delete", function () {
                    var id = $(this).data('id');
                    $(".modal-footer #sayacid").attr('href',"{{ URL::to('suservis/arizakayitsil') }}/"+id );
                });
            },
            "aaSorting": [[6,'desc']],
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-tag"></i>Sisteme Girilen Su Arıza Kayıtları
                    </div>
                    <div class="actions">
                        <a class="btn btn-default btn-sm rapor">
                            <i class="fa fa-search"></i> Servis Raporu </a>

                        <a href="{{ URL::to('suservis/arizakayitekle') }}" class="btn btn-default btn-sm">
