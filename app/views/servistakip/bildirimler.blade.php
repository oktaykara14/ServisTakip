...
<div class="page-title">
    <h1>Servis Takip <small>Bildirimler Ekranı</small></h1>
</div>
@stop
...
@section('scripts')
    ...
    <script>
        ...
        var oTable = table.DataTable({
            ...
            "bProcessing": true,
            "ajax": {
                "url": "{{ URL::to('servistakip/bildirimlist') }}",
                "type": "POST",
                "data": {
                    "bildirimdurum" : "@if(isset($bildirimdurum)){{$bildirimdurum}}@endif" ,
    ...
    <script>
        $(document).on("click", ".ok", function () {
            var id = $(this).data('id');
            $.getJSON("{{ URL::to('servistakip/bildirimdurum')}}",{id:id},function(event){
                toastr.options = {
        ...
        $(document).on("click", ".all-ok", function () {
            var id=0;
            $.getJSON("{{ URL::to('servistakip/bildirimdurum')}}",{id:id},function(event){
                toastr.options = {
                    closeButton: true,debug: false,positionClass: "toast-top-right",onclick: null,
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-tag"></i>Sistemdeki Bildirimler
                    </div>
                    <div class="actions">
                        <a class="btn btn-default btn-sm all-ok"><i class="fa fa-check"></i> Tümünü Okundu Olarak İşaretle </a>
                    </div>
                </div>
