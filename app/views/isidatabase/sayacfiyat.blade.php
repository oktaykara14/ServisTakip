...
<div class="page-title">
    <h1>Isı Servis <small>Sayaç Fiyatları Bilgi Ekranı</small></h1>
</div>
@stop
...
@section('scripts')
    ...
    <script>
        ...
        var oTable = table.DataTable({
            ...
            "bProcessing": true,
            "ajax": {
                "url": "{{ URL::to('isidatabase/sayacfiyatlist') }}",
                "type": "POST",
                "data": {
                }
            },
            ...
            "columns": [
                {data: 'id', name: 'sayacfiyat.id',"class":"id","orderable": true, "searchable": true},
                ...
                {data: 'fiyat', name: 'sayacfiyat.fiyat',"orderable": true, "searchable": true},
    ...
    $(document).on("click", ".delete", function() {
         var id = $(this).data('id');
         $(".modal-footer #sayacid").attr('href',"{{ URL::to('isidatabase/fiyatsil') }}/"+id);
    });
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-tag"></i>Sayaç Fiyatları
                    </div>
                    <div class="actions">
                        <a href="{{ URL::to('isidatabase/fiyatekle') }}" class="btn btn-default btn-sm">
                            <i class="fa fa-pencil"></i> Yeni Sayaç Fiyatı Ekle </a>
                    </div>
                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Sayac Fiyatı Silinecek</h4>
                </div>
                <div class="modal-body">
                    Seçilen Sayaç Fiyatını Silmek İstediğinizden Emin Misiniz?
                </div>
