...
<div class="page-title">
    <h1>Isı Sayaç Adı <small>Ekleme Ekranı</small></h1>
</div>
@stop
...
@section('page-script')
<script src="{{ URL::to('pages/isidatabase/form-validation-2.js') }}"></script>
@stop
...
<div class="portlet box">
    ...
    <div class="portlet-body form">
        <!-- BEGIN FORM-->
        <form action="{{ URL::to('isidatabase/sayacadiekle') }}" id="form_sample" method="POST" class="form-horizontal" novalidate="novalidate">
            <div class="form-body">
                ...
                <div class="form-group">
                        ...
                        <div class="col-xs-6">
                                <div class="bootstrap-switch bootstrap-switch-wrapper bootstrap-switch-off bootstrap-switch-animate" style="width: 116px;">
                                    ...
                                    <input type="checkbox" id="cap" name="cap" class="make-switch" data-on-color="success" data-off-color="warning" data-on-text="Evet" data-off-text="Hayır" @if(Input::old('cap')) checked @endif></div>
                                </div>
                        </div>
                </div>
                <div class="form-group">
            ...
            <div class="row">
                <div class="col-xs-12" style="text-align: center">
                    ...
                    <a href="{{ URL::to('isidatabase/sayacadi')}}" class="btn default">Vazgeç</a>
                </div>
            </div>
            </div>
        </form>
