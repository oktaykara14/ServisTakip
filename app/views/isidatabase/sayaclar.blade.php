...
<div class="page-title">
    <h1>Isı Servis <small>Sayaç Listesi</small></h1>
</div>
@stop
...
@section('scripts')
    ...
    <script>
        ...
        var oTable = table.DataTable({
            ...
            "bProcessing": true,
            "ajax": {
                "url": "{{ URL::to('isidatabase/sayaclist') }}",
                "type": "POST",
                "data": {
                }
            },
            ...
            "columns": [
                {data: 'id', name: 'sayac.id',"class":"id","orderable": true, "searchable": true},
                {data: 'serino', name: 'sayac.serino',"orderable": true, "searchable": true},
                {data: 'cihazno', name: 'sayac.cihazno',"orderable": true, "searchable": true},
                {data: 'sayacadi', name: 'sayacadi.sayacadi',"orderable": true, "searchable": false},
                {data: 'capadi', name: 'sayaccap.capadi',"orderable": true, "searchable": false},
                {data: 'yeradi', name: 'uretimyer.yeradi',"orderable": true, "searchable": false},
                {data: 'uretimtarihi', name: 'sayac.uretimtarihi',"orderable": true, "searchable": false},
                {data: 'guretimtarihi', name: 'sayac.guretimtarihi',"visible": false, "searchable": true},
                {data: 'nsayacadi', name: 'sayacadi.nsayacadi',"visible": false, "searchable": true},
                {data: 'ncapadi', name: 'sayaccap.ncapadi',"visible": false, "searchable": true},
    ...
    $(document).on("click", ".delete", function() {
         var id = $(this).data('id');
         $(".modal-footer #sayacid").attr('href',"{{ URL::to('isidatabase/sayacsil') }}/"+id);
    });
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-tag"></i>Sayaç Listesi
                    </div>
                    <div class="actions">
                        <a href="{{ URL::to('isidatabase/tektekekle') }}" class="btn btn-default btn-sm">
                            <i class="fa fa-pencil"></i> Tek Tek Sayaç Ekle </a>
                        <a href="{{ URL::to('isidatabase/siraliekle') }}" class="btn btn-default btn-sm">
                            <i class="fa fa-pencil"></i> Grup Halinde Sayaç Ekle </a>
                    </div>
                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Sayaç Tanımı Silinecek</h4>
                </div>
                <div class="modal-body">
                    Seçilen Sayaç Tanımını Silmek İstediğinizden Emin Misiniz?
                </div>
