...
<div class="page-title">
    <h1>Isı Servis <small>Sayaç Parçaları Bilgi Ekranı</small></h1>
</div>
@stop
...
@section('scripts')
    ...
    <script>
        ...
        var oTable = table.DataTable({
            ...
            "bProcessing": true,
            "ajax": {
                "url": "{{ URL::to('isidatabase/sayacparcalist') }}",
                "type": "POST",
                "data": {
                }
            },
            ...
            "columns": [
                {data: 'id', name: 'sayacparca.id',"class":"id","orderable": true, "searchable": true},
                ...
                {data: 'parcasayi', name: 'sayacparca.parcasayi',"orderable": true, "searchable": true},
        ...
        $('<label>Kriter: </label><select style="height: 34px;margin-left: 5px;border-radius: 4px;padding-top:2px;padding-right: 10px" id="kriter" tabindex="-1" title="" class="select2me">'+
            ...
            '<option value="6">Çapı</option>'+
            '<option value="3">Servis Kodu</option>'+
            '<option value="4">Parça Sayısı</option>'+
    ...
    $(document).on("click", ".delete", function() {
         var id = $(this).data('id');
         $(".modal-footer #sayacid").attr('href',"{{ URL::to('isidatabase/parcasil') }}/"+id );
    });
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-tag"></i>Sayaç Parçaları
                    </div>
                    <div class="actions">
                        <a href="{{ URL::to('isidatabase/parcaekle') }}" class="btn btn-default btn-sm">
                            <i class="fa fa-pencil"></i> Yeni Sayaç Parçası Ekle </a>
                    </div>
                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Sayaca ait Parçalar Silinecek</h4>
                </div>
                <div class="modal-body">
                    Seçilen Sayaç Parçalarını Silmek İstediğinizden Emin Misiniz?
                </div>
