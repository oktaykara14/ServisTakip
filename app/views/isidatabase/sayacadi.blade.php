...
<div class="page-title">
    <h1>Isı Servis <small>Sayaç İsimleri Bilgi Ekranı</small></h1>
</div>
@stop
...
@section('scripts')
    ...
    <script>
        ...
        var oTable = table.DataTable({
            ...
            "bProcessing": true,
            "ajax": {
                "url": "{{ URL::to('isidatabase/sayacadilist') }}",
                "type": "POST",
                "data": {
                }
            },
            ...
            "columns": [
                {data: 'id', name: 'sayacadi.id',"class":"id","orderable": true, "searchable": true},
                {data: 'sayacadi', name: 'sayacadi.sayacadi',"orderable": true, "searchable": false},
                {data: 'marka', name: 'sayacmarka.marka',"orderable": true, "searchable": false},
                {data: 'tipadi', name: 'sayactip.tipadi',"orderable": true, "searchable": false},
                {data: 'gcap', name: 'sayacadi.gcap',"orderable": true, "searchable": false},
                {data: 'gbeyanname', name: 'sayacadi.gbeyanname',"orderable": true, "searchable": false},
                {data: 'nsayacadi', name: 'sayacadi.nsayacadi',"visible": false, "searchable": true},
                {data: 'nmarka', name: 'sayacmarka.nmarka',"visible": false, "searchable": true},
                {data: 'ntipadi', name: 'sayactip.ntipadi',"visible": false, "searchable": true},
                {data: 'ncap', name: 'sayacadi.ncap',"visible": false, "searchable": true},
                {data: 'nbeyanname', name: 'sayacadi.nbeyanname',"visible": false, "searchable": true},
        ...
        $('<label>Kriter: </label><select style="height: 34px;margin-left: 5px;border-radius: 4px;padding-top:2px;padding-right: 10px" id="kriter" tabindex="-1" title="" class="select2me">'+
            ...
            '<option value="6">Sayaç Adı</option>'+
            '<option value="7">Sayaç Markası</option>'+
            '<option value="8">Sayaç Tipi</option>'+
            '<option value="9">Sayaç Çapı</option>'+
            '<option value="10">Beyanname</option>'+
    ...
    $(document).on("click", ".delete", function() {
         var id = $(this).data('id');
         $(".modal-footer #sayacid").attr('href',"{{ URL::to('isidatabase/sayacadisil') }}/"+id );
    });
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-tag"></i>Sayaç İsimleri
                    </div>
                    <div class="actions">
                        <a href="{{ URL::to('isidatabase/sayacadiekle') }}" class="btn btn-default btn-sm">
                            <i class="fa fa-pencil"></i> Yeni Sayaç Adı Ekle </a>
                    </div>
                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Sayac Adı Silinecek</h4>
                </div>
                <div class="modal-body">
                    Seçilen Sayaç Adını Silmek İstediğinizden Emin Misiniz?
                </div>
