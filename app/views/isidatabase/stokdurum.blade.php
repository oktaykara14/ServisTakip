...
@section('page-title')
    <div class="page-title">
        <h1>Isı Servis <small>Sayaç Parça Stok Bilgi Ekranı</small></h1>
    </div>
@stop
...
@section('scripts')
    ...
    <script>
        ...
        var oTable = table.DataTable({
            ...
            "bProcessing": true,
            "ajax": {
                "url": "{{ URL::to('isidatabase/stoklist') }}",
                "type": "POST",
                "data": {
                }
            },
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-tag"></i>Isı Servis Depo Stok Durumları
                    </div>
                    <div class="actions">
                        <a href="{{ URL::to('isidatabase/stokdurumekle') }}" class="btn btn-default btn-sm">
