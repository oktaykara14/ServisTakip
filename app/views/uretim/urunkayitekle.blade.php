...
<div class="page-title">
    <h1>Ürün Kayıt <small>Ekleme Ekranı</small></h1>
</div>
@stop
...
<script>
    $(document).ready(function() {
        ...
        if(secilenler!==""){
            $.blockUI();
            $.getJSON("{{ URL::to('uretim/urunkayitbilgi') }}",{secilenler:secilenler},function(event){
                if(event.durum){
...
<div class="portlet box">
    <div class="portlet-title">
        <div class="caption">
            <i class="fa fa-plus"></i>Ürün Kayıdı Ekle
        </div>
    </div>
    <div class="portlet-body form">
        <!-- BEGIN FORM-->
        <form action="{{ URL::to('uretim/urunkayitekle') }}" id="form_sample" method="POST" class="form-horizontal" novalidate="novalidate">
            <div class="form-body">
                                ...
                                <div id="collapse_{{$i}}" class="panel-collapse in">
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group col-sm-6 col-xs-12">
                                            ...
                                            <div class="input-icon right col-xs-8 col-sm-6">
                                                <i class="fa"></i>
                                                <input type="text" id="adet{{$i}}" name="adet[]" class="form-control adet" value="{{Input::old('adet.'.$i)}}">
                                            </div>
                                            ...
                                            <div class="input-icon right col-xs-8">
                                                ...
                                                <select class="form-control select2me valid{{$i}} uretici uretici{{$i}}" id="uretici{{$i}}" name="uretici[]" tabindex="-1" title="">' +
                                                    ...
                                                    @foreach($ureticiler as $uretici)
                                                        @if(Input::old('uretici.'.$i)==$uretici->id)
                                        ...
                                        <div class="form-group col-sm-6 col-xs-12">
                                            ...
                                            <div class="input-icon right col-xs-8">
                                                ...
                                                <div class="input-group input-medium date date-picker" style="padding-left: 12px !important;" data-date-format="dd-mm-yyyy" data-date-viewmode="years">
                                                    <input id="uretimtarih{{$i}}" type="text" name="uretimtarih[]" class="form-control"  value="{{Input::old('uretimtarih') ? Input::old('uretimtarih.'.$i) : '' }}">
                                        ...
                                        <div class="form-group col-xs-12">
                                            <label class="control-label col-sm-2 col-xs-6">Diğer Bilgiler (Barkod vb.):</label>
                                            <div class="col-sm-3 col-xs-6">
                                                <input type="text" id="barkod1{{$i}}" name="barkod1[]" class="form-control barkod1" value="{{Input::old('barkod1.'.$i)}}">
                                            </div>
                                            <div class="col-sm-3 col-xs-6">
                                                <input type="text" id="barkod2{{$i}}" name="barkod2[]" class="form-control barkod2" value="{{Input::old('barkod2.'.$i)}}">
                                            </div>
                                            <div class="col-sm-3 col-xs-6">
                                                <input type="text" id="barkod3{{$i}}" name="barkod3[]" class="form-control barkod3" value="{{Input::old('barkod3.'.$i)}}">
                                            </div>
                                        </div>
                                        <div class="form-group col-xs-6 col-xs-12">
                                        ...
                                        <div class="form-group col-xs-6 col-xs-12 muadildurum{{$i}} hide">
                                            <label class="col-xs-4 col-sm-4 control-label">Hangi ürün için?:<span class="required" aria-required="true"> * </span></label>
                                            <div class="input-icon right col-xs-8 col-sm-6">
                                                ...
                                                <input type="text" id="muadilkod{{$i}}" name="muadilkod[]" class="form-control muadilkod hide" value="{{Input::old('muadilkod.'.$i) ? Input::old('muadilkod.'.$i) : "" }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
