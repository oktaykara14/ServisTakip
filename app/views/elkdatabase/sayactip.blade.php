...
<div class="page-title">
    <h1>Elektrik Servis <small>Sayaç Tipleri Bilgi Ekranı</small></h1>
</div>
@stop
...
@section('scripts')
    ...
    <script>
        ...
        var oTable = table.DataTable({
            ...
            "bProcessing": true,
            "ajax": {
                "url": "{{ URL::to('elkdatabase/sayactiplist') }}",
                "type": "POST",
                "data": {
                }
            },
    ...
    $(document).on("click", ".delete", function() {
         var id = $(this).data('id');
         $(".modal-footer #sayacid").attr('href',"{{ URL::to('elkdatabase/sayactipsil') }}/"+id);
    });
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box">
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        <a href="{{ URL::to('elkdatabase/sayactipekle') }}" class="btn btn-default btn-sm">
