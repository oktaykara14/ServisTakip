...
@section('page-script')
    <script src="{{ URL::to('pages/elkdatabase/form-validation-15.js') }}"></script>
@stop
...
@endif
 $('#netsiscari').on('change', function () {
     ...
     if(id!==""){
         $.blockUI();
         $.getJSON("{{ URL::to('elkdatabase/cariyerbilgi') }}",{netsiscariid:id}, function (event) {
             if(event.durum){
                var uretimyer="";
...
@section('content')
    <div class="portlet box">
        ...
        <div class="portlet-body form">
            <!-- BEGIN FORM-->
            <form action="{{ URL::to('elkdatabase/yetkiliduzenle/'.$yetkili->id.'') }}" id="form_sample" method="POST" class="form-horizontal" novalidate="novalidate">
                <div class="form-body">
                ...
                <div class="form-actions">
                    <div class="row">
                        <div class="col-xs-12" style="text-align: center">
                            ...
                            <a href="{{ URL::to('elkdatabase/yetkilikisi')}}" class="btn default">Vazgeç</a>
                        </div>
                    </div>
                </div>
            </form>
