...
@section('page-title')
    <div class="page-title">
        <h1>Elektrik Servis <small>Sayaç Parça Stok Bilgi Ekranı</small></h1>
    </div>
@stop
...
@section('scripts')
    ...
    <script>
        ...
        var oTable = table.DataTable({
            ...
            "bProcessing": true,
            "ajax": {
                "url": "{{ URL::to('elkdatabase/stoklist') }}",
                "type": "POST",
                "data": {
                }
            },
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-tag"></i>Elektrik Servis Depo Stok Durumları
                    </div>
                    <div class="actions">
                        <a href="{{ URL::to('elkdatabase/stokdurumekle') }}" class="btn btn-default btn-sm">
