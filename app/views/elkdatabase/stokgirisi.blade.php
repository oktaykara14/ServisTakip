...
@section('page-title')
    <div class="page-title">
        <h1>Elektrik Servis <small>Depo Stok Girişi Bilgi Ekranı</small></h1>
    </div>
@stop
...
@section('scripts')
    ...
    <script>
        ...
        var oTable = table.DataTable({
            ...
            "bProcessing": true,
            "ajax": {
                "url": "{{ URL::to('elkdatabase/stokgirislist') }}",
                "type": "POST",
                "data": {
                }
            },
    ...
    <script>
        $(document).on("click", ".delete", function () {
            var id = $(this).data('id');
            $(".modal-footer #sayacid").attr('href',"{{ URL::to('elkdatabase/stokhareketsil') }}/"+id);
        });
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-tag"></i>Elektrik Servis Depo Stok Girişi Manuel
                    </div>
                    <div class="actions">
                        <a href="{{ URL::to('elkdatabase/stokhareketekle') }}" class="btn btn-default btn-sm">
