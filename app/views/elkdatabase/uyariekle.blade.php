...
<div class="page-title">
    <h1>Elektrik Sayaç Uyarı & Sonuç <small>Ekleme Ekranı</small></h1>
</div>
@stop
...
<div class="portlet box">
    ...
    <div class="portlet-body form">
        <!-- BEGIN FORM-->
        <form action="{{ URL::to('elkdatabase/uyariekle') }}" id="form_sample" method="POST" class="form-horizontal" novalidate="novalidate">
            <div class="form-body">
