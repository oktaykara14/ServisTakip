...
<div class="page-title">
    <h1>Elektrik Sayaç Değişen Parça <small>Bilgi Düzenleme Ekranı</small></h1>
</div>
@stop
...
@section('page-script')
<script src="{{ URL::to('pages/elkdatabase/form-validation-5.js') }}"></script>
@stop
...
<div class="portlet box">
    ...
    <div class="portlet-body form">
        <!-- BEGIN FORM-->
        <form action="{{ URL::to('elkdatabase/degisenduzenle/'.$degisen->id.'') }}" id="form_sample" method="POST" class="form-horizontal" novalidate="novalidate">
            <div class="form-body">
            ...
            <div class="row">
                <div class="col-xs-12" style="text-align: center">
                    ...
                    <a href="{{ URL::to('elkdatabase/degisenler')}}" class="btn default">Vazgeç</a>
                </div>
            </div>
            </div>
        </form>
