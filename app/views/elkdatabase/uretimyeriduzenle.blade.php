...
@section('page-script')
<script src="{{ URL::to('pages/elkdatabase/form-validation-16.js') }}"></script>
@stop
...
<div class="portlet box">
    ...
    <div class="portlet-body form">
        <!-- BEGIN FORM-->
        <form action="{{ URL::to('elkdatabase/uretimyeriduzenle/'.$uretimyer->id.'') }}" id="form_sample" method="POST" class="form-horizontal" novalidate="novalidate">
            <div class="form-body">
            ...
            <div class="row">
                <div class="col-xs-12" style="text-align: center">
                    ...
                    <a href="{{ URL::to('elkdatabase/uretimyeri')}}" class="btn default">Vazgeç</a>
                </div>
            </div>
            </div>
        </form>
