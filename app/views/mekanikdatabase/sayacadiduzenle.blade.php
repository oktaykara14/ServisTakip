...
<div class="page-title">
    <h1>Mekanik Gaz Sayaç Adı <small>Bilgi Düzenleme Ekranı</small></h1>
</div>
@stop
...
<div class="portlet box">
    ...
    <div class="portlet-body form">
        <!-- BEGIN FORM-->
        <form action="{{ URL::to('mekanikdatabase/sayacadiduzenle/'.$sayacadi->id.'') }}" id="form_sample" method="POST" class="form-horizontal" novalidate="novalidate">
            <div class="form-body">
                    ...
                    <div class="input-icon right col-xs-6">
                        <i class="fa"></i><select class="form-control select2me select2-offscreen" id="kalibrasyontip" name="kalibrasyontip" tabindex="-1" title="">
                            ...
                            @foreach($kalibrasyontipleri as $kalibrasyontip)
                                @if((Input::old('kalibrasyontip') ? Input::old('kalibrasyontip') :$sayacadi->kalibrasyontipi_id)==$kalibrasyontip->id )
