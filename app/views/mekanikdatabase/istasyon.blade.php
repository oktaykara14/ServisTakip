...
<div class="page-title">
    <h1>Mekanik Gaz Servis <small>İstasyon Bilgi Ekranı</small></h1>
</div>
@stop
...
@section('scripts')
    ...
    <script>
        ...
        var oTable = table.DataTable({
            ...
            "bProcessing": true,
            "ajax": {
                "url": "{{ URL::to('mekanikdatabase/istasyonlist') }}",
                "type": "POST",
                "data": {
                }
            },
            ...
            "columns": [
                {data: 'id', name: 'istasyon.id',"class":"id","orderable": true, "searchable": true},
                {data: 'istasyonadi', name: 'istasyon.istasyonadi',"orderable": true, "searchable": false},
                {data: 'sayacsayi', name: 'istasyon.sayacsayi',"orderable": true, "searchable": true},
                {data: 'sayacadlari', name: 'istasyon.sayacadlari',"orderable": true, "searchable": true},
                {data: 'nistasyonadi', name: 'istasyon.nistasyonadi',"visible": false, "searchable": true},
        ...
        $('<label>Kriter: </label><select style="height: 34px;margin-left: 5px;border-radius: 4px;padding-top:2px;padding-right: 10px" id="kriter" tabindex="-1" title="" class="select2me">'+
            ...
            '<option value="4">İstasyon Adı</option>'+
            '<option value="2">Sayaç Sayısı</option>'+
            '<option value="3">Sayaç Adları</option>'+
    ...
    $(document).on("click", ".delete", function() {
         var id = $(this).data('id');
         $(".modal-footer #sayacid").attr('href',"{{ URL::to('mekanikdatabase/istasyonsil') }}/"+id);
    });
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-tag"></i>İstasyon Bilgileri
                    </div>
                    <div class="actions">
                        <a href="{{ URL::to('mekanikdatabase/istasyonekle') }}" class="btn btn-default btn-sm">
                            <i class="fa fa-pencil"></i> Yeni İstasyon Ekle </a>
                    </div>
                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">İstasyon Bilgisi Silinecek</h4>
                </div>
                <div class="modal-body">
                    Seçilen İstasyon Bilgisini Silmek İstediğinizden Emin Misiniz?
                </div>
