...
<div class="page-title">
    <h1>Mekanik Gaz Stok-Parça Grubu <small>Ekleme Ekranı</small></h1>
</div>
@stop
...
@section('page-script')
<script src="{{ URL::to('pages/mekanikdatabase/form-validation-6.js') }}"></script>
@stop
...
<div class="portlet box">
    <div class="portlet-title">
        <div class="caption">
            <i class="fa fa-plus"></i>Stok-Parça Grubu Ekle
        </div>
    </div>
    <div class="portlet-body form">
        <!-- BEGIN FORM-->
        <form action="{{ URL::to('mekanikdatabase/stokdurumekle') }}" id="form_sample" method="POST" class="form-horizontal" novalidate="novalidate">
            <div class="form-body">
                    ...
                    <div class="input-icon right col-xs-8">
                        <i class="fa"></i><select class="form-control select2me select2-offscreen" id="stokadi" name="stokadi" tabindex="-1" title="">
                            ...
                            @foreach($netsisstokkodlari as $netsisstokkod)
                                @if(Input::old('stokadi')==$netsisstokkod->id )
                    ...
                    <div class="input-icon right col-xs-8">
                        <i class="fa"></i><select class="form-control select2me select2-offscreen" id="depokodu" name="depokodu" tabindex="-1" title="">
                            ...
                            @foreach($netsisdepolar as $netsisdepo)
                                @if(Input::old('depokodu')==$netsisdepo->kodu )
            ...
            <div class="row">
                <div class="col-xs-12" style="text-align: center">
                    ...
                    <a href="{{ URL::to('mekanikdatabase/stokdurum')}}" class="btn default">Vazgeç</a>
                </div>
            </div>
            </div>
        </form>
