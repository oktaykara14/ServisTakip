...
@section('page-title')
    <div class="page-title">
        <h1>Gaz Servis <small>Sayaç Uyarılar & Sonuçlar Bilgi Ekranı</small></h1>
    </div>
@stop
...
@section('scripts')
    ...
    <script>
        ...
        var oTable = table.DataTable({
            ...
            "bProcessing": true,
            "ajax": {
                "url": "{{ URL::to('mekanikdatabase/uyarilarlist') }}",
                "type": "POST",
                "data": {
                }
            },
            ...
            "columns": [
                {data: 'id', name: 'uyarilar.id',"class":"id","orderable": true, "searchable": true},
                {data: 'tanim', name: 'uyarilar.tanim',"orderable": true, "searchable": false},
                {data: 'gdurum', name: 'uyarilar.gdurum',"orderable": true, "searchable": false},
                {data: 'ntanim', name: 'uyarilar.ntanim',"visible": false, "searchable": true},
                {data: 'ndurum', name: 'uyarilar.ndurum',"visible": false, "searchable": true},
    ...
    <script>
        $(document).on("click", ".delete", function () {
            var id = $(this).data('id');
            $(".modal-footer #sayacid").attr('href',"{{ URL::to('mekanikdatabase/uyarisil') }}/"+id);
        });
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-tag"></i>Sayaç Uyarılar & Sonuçlar
                    </div>
                    <div class="actions">
                        <a href="{{ URL::to('mekanikdatabase/uyariekle') }}" class="btn btn-default btn-sm">
                            <i class="fa fa-pencil"></i> Yeni Sayaç Uyarı & Sonucu Ekle </a>
                    </div>
                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Sayaç Uyarı & Sonucu Silinecek</h4>
                </div>
                <div class="modal-body">
                    Seçilen Sayaç Uyarı & Sonuç Tanımını Silmek İstediğinizden Emin Misiniz?
                </div>
