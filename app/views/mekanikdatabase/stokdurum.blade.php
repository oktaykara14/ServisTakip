...
@section('page-title')
    <div class="page-title">
        <h1>Mekanik Gaz Servis <small>Sayaç Parça Stok Bilgi Ekranı</small></h1>
    </div>
@stop
...
@section('scripts')
    ...
    <script>
        ...
        var oTable = table.DataTable({
            ...
            "bProcessing": true,
            "ajax": {
                "url": "{{ URL::to('mekanikdatabase/stoklist') }}",
                "type": "POST",
                "data": {
                }
            },
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-tag"></i>Gaz Servis Depo Stok Durumları
                    </div>
                    <div class="actions">
                        <a href="{{ URL::to('mekanikdatabase/stokdurumekle') }}" class="btn btn-default btn-sm">
