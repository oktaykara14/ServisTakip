...
<div class="page-title">
    <h1>Gaz Servis <small>Mekanik Sayaç Hurda Nedenleri Bilgi Ekranı</small></h1>
</div>
@stop
...
@section('scripts')
    ...
    <script>
        ...
        var oTable = table.DataTable({
            ...
            "bProcessing": true,
            "ajax": {
                "url": "{{ URL::to('mekanikdatabase/hurdanedenilist') }}",
                "type": "POST",
                "data": {
                }
            },
            ...
            "columns": [
                {data: 'id', name: 'hurdanedeni.id',"class":"id","orderable": true, "searchable": true},
    ...
    $(document).on("click", ".delete", function() {
         var id = $(this).data('id');
         $(".modal-footer #sayacid").attr('href',"{{ URL::to('mekanikdatabase/hurdanedenisil') }}/"+id);
    });
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-tag"></i>Sayaç Hurda Nedenleri
                    </div>
                    <div class="actions">
                        <a href="{{ URL::to('mekanikdatabase/hurdanedeniekle') }}" class="btn btn-default btn-sm">
                            <i class="fa fa-pencil"></i> Yeni Hurda Nedeni Ekle </a>
                    </div>
                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Sayaç Hurda Nedeni Silinecek</h4>
                </div>
                <div class="modal-body">
                    Seçilen Sayaç Hurda Nedenini  Silmek İstediğinizden Emin Misiniz?
                </div>
