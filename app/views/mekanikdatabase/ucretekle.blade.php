...
<div class="page-title">
    <h1>Mekanik Gaz Sayaç Parça Ücreti <small>Ekleme Ekranı</small></h1>
</div>
@stop
...
@section('page-script')
<script src="{{ URL::to('pages/mekanikdatabase/form-validation-10.js') }}"></script>
@stop
...
<div class="portlet box">
    <div class="portlet-title">
        <div class="caption">
            <i class="fa fa-plus"></i>Sayaç Parça Ücreti Ekle
        </div>
    </div>
    <div class="portlet-body form">
        <!-- BEGIN FORM-->
        <form action="{{ URL::to('mekanikdatabase/ucretekle') }}" id="form_sample" method="POST" class="form-horizontal" novalidate="novalidate">
            <div class="form-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-8">
                        <input type="tel" id="ucret" name="ucret" value="{{Input::old('ucret') }}" data-required="1" class="form-control">
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-xs-12" style="text-align: center">
                    ...
                    <a href="{{ URL::to('mekanikdatabase/parcaucret')}}" class="btn default">Vazgeç</a>
                </div>
            </div>
            </div>
        </form>
