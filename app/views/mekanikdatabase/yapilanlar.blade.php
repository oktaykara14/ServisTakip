...
@section('page-title')
    <div class="page-title">
        <h1>Mekanik Gaz Servis <small>Sayaç Yapılan İşlemler Bilgi Ekranı</small></h1>
    </div>
@stop
...
@section('scripts')
    ...
    <script>
        ...
        var oTable = table.DataTable({
            ...
            "bProcessing": true,
            "ajax": {
                "url": "{{ URL::to('mekanikdatabase/yapilanlarlist') }}",
                "type": "POST",
                "data": {
                }
            },
            ...
            "columns": [
                {data: 'id', name: 'yapilanlar.id',"class":"id","orderable": true, "searchable": true},
                {data: 'tanim', name: 'yapilanlar.tanim',"orderable": true, "searchable": false},
                {data: 'gdurum', name: 'yapilanlar.gdurum',"orderable": true, "searchable": false},
                {data: 'ntanim', name: 'yapilanlar.ntanim',"visible": false, "searchable": true},
                {data: 'ndurum', name: 'yapilanlar.ndurum',"visible": false, "searchable": true},
    ...
    <script>
        $(document).on("click", ".delete", function () {
            var id = $(this).data('id');
            $(".modal-footer #sayacid").attr('href',"{{ URL::to('mekanikdatabase/yapilansil') }}/"+id);
        });
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-tag"></i>Sayaç Yapılan İşlemler
                    </div>
                    <div class="actions">
                        <a href="{{ URL::to('mekanikdatabase/yapilanekle') }}" class="btn btn-default btn-sm">
                            <i class="fa fa-pencil"></i> Yeni Sayaç Yapılan İşlem Ekle </a>
                    </div>
                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Sayaç Yapılan İşlem Silinecek</h4>
                </div>
                <div class="modal-body">
                    Seçilen Sayaç Yapılan İşlem Tanımını Silmek İstediğinizden Emin Misiniz?
                </div>
