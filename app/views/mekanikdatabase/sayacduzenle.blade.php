...
<div class="page-title">
    <h1>Mekanik Gaz Sayaç <small>Bilgi Düzenleme Ekranı</small></h1>
</div>
@stop
...
@section('page-script')
<script src="{{ URL::to('pages/mekanikdatabase/form-validation-14.js') }}"></script>
@stop
...
<div class="portlet box">
    ...
    <div class="portlet-body form">
        <!-- BEGIN FORM-->
        <form action="{{ URL::to('mekanikdatabase/sayacduzenle/'.$sayac->id.'') }}" id="form_sample" method="POST" class="form-horizontal" novalidate="novalidate">
            <div class="form-body">
                ...
                <div class="form-group">
                    <div class="form-group col-sm-6">
                        ...
                        <div class="input-icon right col-xs-8">
                            <i class="fa"></i><input type="text" id="serino" name="serino" value="{{(Input::old('serino') ? Input::old('serino') :$sayac->serino) }}" data-required="1" class="form-control" maxlength="15">
                        </div>
                    </div>
                </div>
                <div class="form-group">
