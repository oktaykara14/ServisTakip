...
@section('page-title')
    <div class="page-title">
        <h1>Netsis Cari <small>Yetkili Kişi Bilgi Ekranı</small></h1>
    </div>
@stop
...
@section('scripts')
    ...
    <script>
        ...
        var oTable = table.DataTable({
            ...
            "bProcessing": true,
            "ajax": {
                "url": "{{ URL::to('mekanikdatabase/yetkililist') }}",
                "type": "POST",
                "data": {
                }
            },
            ...
            "columns": [
                {data: 'id', name: 'yetkili.id',"class":"id","orderable": true, "searchable": true},
                ...
                {data: 'gaktif', name: 'yetkili.gaktif',"orderable": true, "searchable": false},
                ...
                {data: 'naktif', name: 'yetkili.naktif',"visible": false, "searchable": true},
                {data: 'yerler', name: 'yerler',"orderable": false, "searchable": false},
        ...
        $('<label>Kriter: </label><select style="height: 34px;margin-left: 5px;border-radius: 4px;padding-top:2px;padding-right: 10px" id="kriter" tabindex="-1" title="" class="select2me">'+
            ...
            '<option value="4">Adı Soyadı</option>'+
            '<option value="5">Cari Bilgisi</option>'+
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-tag"></i>Cari Yetkili Kişiler
                    </div>
                    <div class="actions">
                        <a href="{{ URL::to('mekanikdatabase/yetkiliekle') }}" class="btn btn-default btn-sm">
                            <i class="fa fa-pencil"></i> Cari Yetkili Ekle </a>
                    </div>
                </div>
