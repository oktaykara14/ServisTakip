...
<div class="page-title">
    <h1>Mekanik Gaz Servis <small>Sayaç Parçaları Bilgi Ekranı</small></h1>
</div>
@stop
...
@section('scripts')
    ...
    <script>
        ...
        var oTable = table.DataTable({
            ...
            "bProcessing": true,
            "ajax": {
                "url": "{{ URL::to('mekanikdatabase/sayacparcalist') }}",
                "type": "POST",
                "data": {
                }
            },
        ...
        $('<label>Kriter: </label><select style="height: 34px;margin-left: 5px;border-radius: 4px;padding-top:2px;padding-right: 10px" id="kriter" tabindex="-1" title="" class="select2me">'+
            ...
            '<option value="2">Servis Kodu</option>'+
            '<option value="3">Parça Sayısı</option>'+
    ...
    $(document).on("click", ".delete", function() {
         var id = $(this).data('id');
         $(".modal-footer #sayacid").attr('href',"{{ URL::to('mekanikdatabase/parcasil') }}/"+id);
    });
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box">
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        <a href="{{ URL::to('mekanikdatabase/parcaekle') }}" class="btn btn-default btn-sm">
