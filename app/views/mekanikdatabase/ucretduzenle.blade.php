...
<div class="page-title">
    <h1>Mekanik Gaz Sayaç Parça Ücreti <small>Bilgi Düzenleme Ekranı</small></h1>
</div>
@stop
...
<div class="portlet box">
    ...
    <div class="portlet-body form">
        <!-- BEGIN FORM-->
        <form action="{{ URL::to('mekanikdatabase/ucretduzenle/'.$parcaucret->id.'') }}" id="form_sample" method="POST" class="form-horizontal" novalidate="novalidate">
            <div class="form-body">
