...
<div class="page-title">
    <h1>Gaz Kalibrasyon İstasyonu <small>Ekleme Ekranı</small></h1>
</div>
@stop
...
<div class="portlet box">
    <div class="portlet-title">
        <div class="caption">
            <i class="fa fa-plus"></i>Kalibrasyon İstasyonu Ekle
        </div>
    </div>
    <div class="portlet-body form">
        <!-- BEGIN FORM-->
        <form action="{{ URL::to('mekanikdatabase/istasyonekle') }}" id="form_sample" method="POST" class="form-horizontal" novalidate="novalidate">
            <div class="form-body">
                ...
                <div class="form-group">
                    ...
                    <div class="input-icon right col-xs-8">
                        <i class="fa"></i><input type="text" id="istasyonadi" name="istasyonadi" value="{{Input::old('istasyonadi') }}" data-required="1" class="form-control">
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-sm-2 col-xs-4">Test Edilen Sayaç Sayısı: <span class="required" aria-required="true"> * </span></label>
                    <div class="input-icon right col-xs-8">
                        <i class="fa"></i><input type="text" id="sayacsayi" name="sayacsayi" value="{{Input::old('sayacsayi') }}" data-required="1" class="form-control">
                    </div>
                </div>
                <div class="form-group">
