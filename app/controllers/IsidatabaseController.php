...
class IsidatabaseController extends BackendController {
    public $servisadi = 'isidatabase';
    public $servisid = 4;
    public $servisbilgi = 'Isı';
    ...
    public function postSayacadilist() {
        $query = SayacAdi::where('sayacadi.sayactur_id',$this->servisid)
            ->select(array("sayacadi.id","sayacadi.sayacadi","sayacmarka.marka","sayactip.tipadi","sayacadi.gcap","sayacadi.gbeyanname","sayacadi.nsayacadi","sayacmarka.nmarka","sayactip.ntipadi","sayacadi.ncap","sayacadi.nbeyanname"))
    ...
    public function postSayacfiyatlist() {
        $query = SayacFiyat::where('sayacfiyat.sayactur_id',$this->servisid)
            ->select(array("sayacfiyat.id","uretimyer.yeradi","sayacadi.sayacadi","sayaccap.capadi","sayacfiyat.fiyat","uretimyer.nyeradi","sayacadi.nsayacadi","sayaccap.ncapadi","parabirimi.birimi"))
            ->leftjoin("uretimyer","sayacfiyat.uretimyer_id","=","uretimyer.id")
            ->leftjoin("sayacadi","sayacfiyat.sayacadi_id","=","sayacadi.id")
            ->leftjoin("sayaccap","sayacfiyat.sayaccap_id","=","sayaccap.id")
    ...
    public function getFiyatekle() {
        ...
        return View::make($this->servisadi.'.fiyatekle',array('uretimyerleri'=>$uretimyerleri,'sayacadlari'=>$sayacadlari,'sayaccaplari'=>$sayaccaplari))->with(array('title'=>$this->servisbilgi.' Sayaç Fiyatı Ekle'));
    }
    ...
    public function postFiyatekle() {
        try {
            ...
            if (Input::has('sayaccap')) {
                $cap = Input::get('sayaccap');
                If (SayacFiyat::where('uretimyer_id', $yer)->where('sayacadi_id', $sayacadi_id)->where('sayaccap_id', $cap)->first()) {
                    DB::rollBack();
                    Input::flash();
                    return Redirect::back()->withInput()->with(array('mesaj' => 'true', 'title' => 'Kaydetme Hatası', 'text' => 'Bu sayacın bu çapı için seçilen üretim yerine ait fiyat mevcut.', 'type' => 'error'));
                }
            } else {
                $cap = 1;
                If (SayacFiyat::where('uretimyer_id', $yer)->where('sayacadi_id', $sayacadi_id)->where('sayaccap_id', 1)->first()) {
                    DB::rollBack();
                    Input::flash();
                    return Redirect::back()->withInput()->with(array('mesaj' => 'true', 'title' => 'Kaydetme Hatası', 'text' => 'Bu sayacın seçilen üretim yerine ait fiyat mevcut.', 'type' => 'error'));
                }
            }
            $tur = $this->servisid;
    ...
    public function getFiyatduzenle($id) {
        ...
        return View::make($this->servisadi.'.fiyatduzenle',array('sayacfiyat'=>$sayacfiyat,'uretimyerleri'=>$uretimyerleri,'sayacadlari'=>$sayacadlari,'sayaccaplari'=>$sayaccaplari))->with(array('title'=>$this->servisbilgi.' Sayaç Fiyatı Düzenleme Ekranı'));
    }
    ...
    public function postFiyatduzenle($id) {
        try {
            ...
            if (Input::has('sayaccap')) {
                ...
                $cap = 1;
                If (SayacFiyat::where('uretimyer_id', $yer)->where('sayacadi_id', $sayacadi_id)->where('sayaccap_id', 1)->where('id', '<>', $id)->first()) {
                    DB::rollBack();
                    Input::flash();
                    return Redirect::back()->withInput()->with(array('mesaj' => 'true', 'title' => 'Kaydetme Hatası', 'text' => 'Bu sayacın seçilen üretim yerine ait fiyat mevcut.', 'type' => 'error'));
                }
    ...
    public function postSayacparcalist() {
        $query = SayacParca::where('sayacparca.sayactur_id',$this->servisid)
            ->select(array("sayacparca.id","sayacadi.sayacadi","sayaccap.capadi","servisstokkod.stokkodu","sayacparca.parcasayi","sayacadi.nsayacadi","sayaccap.ncapadi"))
            ->leftjoin("sayacadi","sayacparca.sayacadi_id","=","sayacadi.id")
            ->leftjoin("sayaccap","sayacparca.sayaccap_id","=","sayaccap.id")
    ...
    public function getParcaekle() {
        ...
        return View::make($this->servisadi.'.parcaekle',array('sayacadlari'=>$sayacadlari,'sayaccaplari'=>$sayaccaplari,'parcalar'=>$parcalar,'stokkodlari'=>$stokkodlari))->with(array('title'=>$this->servisbilgi.' Sayaç Parçası Ekle'));
    }
        ...
        try {
            ...
            if (Input::has('sayaccap')) {
                ...
                If (SayacParca::where('sayacadi_id', $sayacadi_id)->where('sayaccap_id', $cap)->first()) {
                    DB::rollBack();
                    Input::flash();
                    return Redirect::back()->withInput()->with(array('mesaj' => 'true', 'title' => 'Kaydetme Hatası', 'text' => 'Bu sayacın bu çapı için parçaları mevcut.', 'type' => 'error'));
                }
            } else {
                $cap = 1;
                If (SayacParca::where('sayacadi_id', $sayacadi_id)->where('sayaccap_id', 1)->first()) {
                    DB::rollBack();
                    Input::flash();
                    return Redirect::back()->withInput()->with(array('mesaj' => 'true', 'title' => 'Kaydetme Hatası', 'text' => 'Bu sayacın parçaları mevcut.', 'type' => 'error'));
                }
            }
            if (Input::has('parca')) {
                $parcalargelen = Input::get('parca');
    ...
    public function getParcaduzenle($id) {
        ...
        $stokkodlari=ServisStokKod::where('servisid',$this->servisid)->where('koddurum',1)->get();
        return View::make($this->servisadi.'.parcaduzenle',array('sayacparca'=>$sayacparca,'parcalar'=>$parcalar,'sayacadlari'=>$sayacadlari,'sayaccaplari'=>$sayaccaplari,'stokkodlari'=>$stokkodlari))->with(array('title'=>$this->servisbilgi.' Sayaç Parçaları Düzenleme Ekranı'));
    }
    ...
    public function postParcaduzenle($id) {
        try {
            ...
            if (Input::has('sayaccap')) {
                ...
                $cap = 1;
                If (SayacParca::where('sayacadi_id', $sayacadi_id)->where('sayaccap_id', 1)->where('id', '<>', $id)->first()) {
                    DB::rollBack();
                    Input::flash();
                    return Redirect::back()->withInput()->with(array('mesaj' => 'true', 'title' => 'Kaydetme Hatası', 'text' => 'Bu sayacın parçaları mevcut.', 'type' => 'error'));
                }
    ...
    public function getSayacparcalari(){
        try {
            ...
            if (Input::has('garanti')) {
                if (Input::has('capid')) {
                    $capid=Input::get('capid');
                    $sayacgaranti = SayacGaranti::where('sayacadi_id', $adiid)->where('sayaccap_id', $capid)->first();
                } else {
    ...
    public function postSayacgarantilist() {
        $query = SayacGaranti::where('sayacgaranti.sayactur_id',$this->servisid)
            ->select(array("sayacgaranti.id","uretimyer.yeradi","sayacadi.sayacadi","sayaccap.capadi","sayacgaranti.garanti","uretimyer.nyeradi","sayacadi.nsayacadi","sayaccap.ncapadi"))
            ->leftjoin("uretimyer","sayacgaranti.uretimyer_id","=","uretimyer.id")
            ->leftjoin("sayacadi","sayacgaranti.sayacadi_id","=","sayacadi.id")
            ->leftjoin("sayaccap","sayacgaranti.sayaccap_id","=","sayaccap.id");
        return Datatables::of($query)
    ...
    public function getGarantiekle() {
        ...
        $sayacadlari = SayacAdi::where('sayactur_id',$this->servisid)->get();
        $sayaccaplari = SayacCap::all();
        return View::make($this->servisadi.'.garantiekle',array('uretimyerleri'=>$uretimyerleri,'sayacadlari'=>$sayacadlari,'sayaccaplari'=>$sayaccaplari))->with(array('title'=>$this->servisbilgi.' Sayaç Garanti Süresi Ekle'));
    }
        ...
        try {
            ...
            if (Input::has('sayaccap')) {
                ...
                If (SayacGaranti::where('sayacadi_id', $sayacadi_id)->where('sayaccap_id', $cap)->first()) {
                    DB::rollBack();
                    Input::flash();
                    return Redirect::back()->withInput()->with(array('mesaj' => 'true', 'title' => 'Kaydetme Hatası', 'text' => 'Bu sayacın bu çapı için garanti süresi mevcut.', 'type' => 'error'));
                }
            } else {
                $cap = 1;
                If (SayacGaranti::where('sayacadi_id', $sayacadi_id)->where('sayaccap_id', 1)->first()) {
                    DB::rollBack();
                    Input::flash();
    ...
    public function getGarantiduzenle($id) {
        ...
        return View::make($this->servisadi.'.garantiduzenle',array('sayacgaranti'=>$sayacgaranti,'uretimyerleri'=>$uretimyerleri,'sayacadlari'=>$sayacadlari,'sayaccaplari'=>$sayaccaplari))->with(array('title'=>$this->servisbilgi.' Sayaç Garanti Süresi Düzenleme Ekranı'));
    }
    ...
    public function postGarantiduzenle($id) {
        try {
            ...
            if (Input::has('sayaccap')) {
                ...
                $cap = 1;
                If (SayacGaranti::where('sayacadi_id', $sayacadi_id)->where('sayaccap_id', 1)->where('id', '<>', $id)->first()) {
                    DB::rollBack();
                    Input::flash();
                    return Redirect::back()->withInput()->with(array('mesaj' => 'true', 'title' => 'Kaydetme Hatası', 'text' => 'Bu sayacın garanti süresi mevcut.', 'type' => 'error'));
                }
        ...
        try {
            ...
            try {
                foreach ($serinolar as $serino) {
                    ...
                    if ($sayac) {
                        if ($sayac->sayactur_id == $this->servisid) //sayaç zaten kayıtlı
                        {
                            $flag = 1;
                        } else if (is_null($sayac->sayactur_id)) {
            ...
            if ($flag == 1) {
                ...
                return Redirect::to($this->servisadi.'/sayaclar')->with(array('mesaj' => 'true', 'title' => 'Sayaçların Bazıları Eklenmedi', 'text' => 'Sistemde Kayıtlı Olan Sayaçlar Tekrar Eklenmedi', 'type' => 'success'));
            } else if ($flag == 4) {
