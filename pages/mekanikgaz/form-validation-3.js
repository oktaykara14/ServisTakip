var FormValidationGazServis = function () {
    ...
    var handleValidation = function() {
        ...
        $("#uretim").inputmask("d-m-y",{ "placeholder": "*" ,removeMaskOnSubmit: false});
        ...
        var aksesuarlar;
        if($( "#aksesuarlar" ).hasClass( "aksesuarlar" ))
        {
            aksesuarlar =document.getElementById("aksesuarlar").innerHTML;
            aksesuarlar = aksesuarlar.replace(/\s+/g,' ').trim();
            aksesuarlar = aksesuarlar.split(" ");
            $('#aksesuar').select2("val",aksesuarlar);
        }

        if($( "#aksesuarekli" ).hasClass( "aksesuarekli" ))
        {
            aksesuarlar =document.getElementById("aksesuarekli").innerHTML;
            aksesuarlar = aksesuarlar.split(",");
            $('#aksesuar').select2("val",aksesuarlar);
        }
        form.validate({
