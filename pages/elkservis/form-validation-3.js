var FormValidationElkServis = function () {
    ...
    var handleValidation = function() {
        ...
        $("#t1deger").inputmask("decimal",{
            radixPoint:",",
            groupSeparator: "",
            digits: 3,
            autoGroup: true
        });
        $("#t2deger").inputmask("decimal",{
            radixPoint:",",
            groupSeparator: "",
            digits: 3,
            autoGroup: true
        });
        $("#t3deger").inputmask("decimal",{
            radixPoint:",",
            groupSeparator: "",
            digits: 3,
            autoGroup: true
        });
        $("#t4deger").inputmask("decimal",{
            radixPoint:",",
            groupSeparator: "",
            digits: 3,
            autoGroup: true
        });
        $("#ttoplam").inputmask("decimal",{
            radixPoint:",",
            groupSeparator: "",
            digits: 3,
            autoGroup: true
        });
        $("#kalankredi").inputmask("decimal",{
            radixPoint:",",
            groupSeparator: "",
            digits: 3,
            autoGroup: true
